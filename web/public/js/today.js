...
(function () {
  ...
  var chip = function (p, info) {
    return '<a class="inline-flex items-baseline gap-1.5 bg-cream border border-line rounded-full px-3.5 py-1.5 text-[.92rem] no-underline hover:border-amber" href="' + PAGE + 'p/' + p.slug + '/">' +
