...
zoos:
  - 天津動物園 ( – 現在)
tags: [styani, male, zoo:天津動物園]
sources:
  - 作者提供（2026-07-12：♂、團團之父）
---
...
> 🚧 待查證：出生年、出身（園內繁殖或外園轉入）、父母。查得出生年後，依命名規則應將 slug 更名為 `tu-tu-YYYY` 並同步修正 wikilink。
...
| 姓名 | 出生年 | 另一方親本 |
|------|--------|-----------|
| [[tuan-tuan-2023-06-06]]（團團）| 2023 | [[xiao-bao]]（小寶）|
