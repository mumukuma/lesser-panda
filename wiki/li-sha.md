...
現居**柳州市動物園**，[[mu-shu-2026-06-12]]（木薯）之母（父 [[xi-bao]] 喜寶）。出生年、出身與父母均不詳。

> 🚧 待查證：出生年、出身（園內繁殖或外園轉入）、父母。查得出生年後，依命名規則應將 slug 更名為 `li-sha-YYYY` 並同步修正 wikilink。
...
| 姓名 | 出生年 | 另一方親本 |
|------|--------|-----------|
| [[mu-shu-2026-06-12]]（木薯）| 2026 | [[xi-bao]]（喜寶）|
