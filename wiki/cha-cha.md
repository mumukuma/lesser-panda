...
zoos:
  - 廈門靈玲動物王國 ( – 現在)
tags: [styani, female, zoo:廈門靈玲動物王國]
sources:
...
> ⚠️ 注意同名：另有日本個體 [[cha-cha-1992-07-17]]（チャチャ，恩賜上野）與 [[cha-cha-1997-06-17]]🪐（チャチャ），字同源不同、非同一隻，勿混淆。
>
> 🚧 待查證：出生年、官方來源。查得出生年後，依命名規則應將 slug 更名為 `cha-cha-YYYY` 並同步修正 wikilink。
...
- 父：[[fei-fei-xiamen]]🪐（飛飛）
- 母：[[dou-dou]]（豆豆）
- 三胞胎手足：[[sha-sha]]🪐（沙沙，大哥）、[[mian-mian]]（面面，小弟）
