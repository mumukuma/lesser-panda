...
## [2026-09-01] add | Zoo Leipzig 的 Kamala × Asa 一家四筆建檔：`kamala-2024`・`asa-2024`・雙胞胎兩筆蘋果籽

讀者提供同好 Instagram 貼文（@rene.bildermax，2026-08-31，Zoo Leipzig 拍攝，
`https://www.instagram.com/rene.bildermax/p/DcpielDiHGt/`；德文說明「Bild 1. & 4. Mutter und Tochter／
Bild 2. & 3. Brüderchen und Schwesterchen」）詢問是否已建檔。比對結果：**萊比錫動物園此前一隻都沒收**
（`data/zoos.json` 早有 Zoo Leipzig 登記，但無任何條目引用），本輪依園方公告補建四筆。

**四筆條目**：`kamala-2024` ♀（母）、`asa-2024` ♂（父）、
`apple-seed-1-kamala-leipzig-2026-06-03`、`apple-seed-2-kamala-leipzig-2026-06-03`（雙胞胎，2026-06-03 生）。

**園方來源逐條**：2025-07-01〈Neues Rote Pandaweibchen zu sehen〉（Kamala 5 月中自法國來園、前一對 Lilo
與 Zimai 於 2024 年過世）／2025-07-18〈Gesellschaft für Rotes Pandaweibchen Kamala〉（Asa 前一日到園、
13 個月大、來自一座法國動物園、Kamala 記「(1)」、園長 Jörg Junhold 談 EEP 重新配對）／
2026-06-17〈Erstmals Nachwuchs bei den Südpudus & Roten Pandas〉（6 月 3 日產仔、推測兩隻、父獸 Asa）／
2026-07-18〈Nachwuchs bei den Roten Pandas〉（確認雙胞胎、母獸記為「Nepalesisches」＝亞種 fulgens 有官方佐證）。
非官方補充記 `extra_sources`：t-online 2026-08-18（徵名活動、**公布一雌一雄**、8/31 截止）、
Leipziger Zeitung 2026-06-26（Asa「aus der Normandie stammende」）。

**三項刻意的保守處理**：

1. **`sex` 兩隻都留空**。園方只說「一雌一雄」、未指明哪隻是哪隻；胎次層級的資訊寫在內文與 index，
   不下到個體層級去猜。園方命名時通常一併公布性別，屆時回補。
2. **親獸只記生年**（`born: 2024`）。公告只給括號年齡（Kamala 到園時 1 歲、Asa 13 個月）與
   「aus Frankreich」，無生日、無出生園 → 兩隻都加 `birth_zoo: unknown`，居住史首站不掛 🐣。
   Kamala 的到園日只記到年（公告寫「Mitte Mai」，不補日）；Asa 有確切日 2025-07-17（「seit gestern」）。
3. **蘋果籽 slug 額外帶園名 `leipzig`**（`apple-seed-N-kamala-leipzig-生日`）。標準規則是
   `apple-seed-媽媽名-生日`，但 wiki 現有**兩隻同名 Kamala 各在 2026 年產下雙胞胎**——克萊沃的
   `kamala-2021-06-14` 那胎生於 2026-06-21，萊比錫這胎 2026-06-03，只差 18 天，照標準規則會產生
   `apple-seed-1-kamala-2026-06-21` 與 `apple-seed-1-kamala-2026-06-03` 這種極易誤讀的一組 slug。
   轉正命名後此偏離自然消失。**若維護者偏好嚴格照規則，以 `tools/rename.py` 一鍵改回即可。**

**查證過但沒結果的方向**（避免日後重跑）：Kamala／Asa 兩隻**RPF 與 redpanda-lineage 都查無**
（RPF 上的 Kamala 是 Colchester #996 與 Liberec #1361；Asa 是 National Zoological Park 那隻 ♂，
另有法國 Parc de Clères 出身的**雌獸** Asa（2020-06-04 生、2021 移居 Mulhouse）——同名不同隻）。
Asa 的法國娘家找不到指名來源：諾曼第有小熊貓的園有 Parc de Clères／Cerza／Biotropica 等，搜了兩輪未定案。
另已排除「Kamala 來自 Beauval 2024-06-21 那胎」的可能——該胎兩隻已建檔為 `mushu-2024-06-21`／
`aksou-2024-06-21`，皆為 ♂ 且仍在 Beauval。

**順帶**：`data/zoos.json` 的 Zoo Leipzig 補 `location_zh`「薩克森邦萊比錫」與 aliases
（Leipzig Zoo／Leipzig Zoological Garden）；`location_ja` 依非漢字圈慣例維持 null。
前任種獸 Lilo 與 Zimai（2024 年過世、園方未公布日期）未建條目。

## [2026-09-01] add | 京都市動物園官方家系圖：`Du-Du`(1983-06-16)・`Mei-Mei`(1983-06-16)・`You-You`(1986-06-23) 建檔，另三處校訂

讀者分享京都市動物園「あのね」826 號（御意見箱への回答 R8.6.1～6.30，
`https://zoo.city.kyoto.lg.jp/zoo/uploads/image/anone826.pdf`）。該 PDF 內文只說
「これまで飼育したレッサーパンダは 30 頭（1960 年～2026 年）で、うち 16 頭が本園生まれ」，
**真正的資料在下半頁那張歷代家系圖**——它是嵌在 PDF 裡的 JPEG（物件 `Im1`，733×554），
文字抽取抓不到，須把圖取出放大判讀。逐格轉錄存 `sources/kyoto-anone826/anone826.md`
（30 格、番号／名／在園年／紅框本園生まれ／親子連線）。紅框恰 16 格，與內文「16 頭」相符。

**對帳結果：wiki 有 16／30。** 缺 14 隻——`001M`／`002F`（1960–1962）、`004F` 平平（1980–1981，
ISB 全簿亦查無）、`006M` 都都＝ISB `8329`、`007F` 美美＝`8330`、`009M` 陽陽＝`8642`、
`012M` 梨梨＝`9063`、`013F` 桃桃＝`9064`、`019M`（ムータン 同胎）、`021F`／`022U`（ウーロン×コト 2014）、
`034F`／`035M`／`036F`（ウーロン×ミーミー 2023，全部當年夭折）。

本輪依維護者裁定處理四件：

1. **建檔三隻**（生日已由 ISB 釘死者）：`du-du-1983-06-16` 都都 ♂（`8329`，1987-06-18 歿）、
   `mei-mei-1983-06-16` 美美 ♀（`8330`，1987-06-29 歿）、`you-you-1986-06-23` 陽陽 ♂
   （`8642`，1987-07-17 歿）。三隻此前都以「（未命名）」記在 `an-an-1978`／`raku-raku-1980`／
   `shin-shin-1986-06-23`／`yan-yan-1985-05-31` 的子女・手足表，本輪全部改為 wikilink。
   都都×美美、陽陽×幸幸 各為雙胞胎。
   🚧 **片假名讀音家系圖未印**：維護者裁定採官話式讀法（比照同園有園方佐證的 安安＝アンアン、
   洋洋＝ヤンヤン），但 **陽陽 刻意避開 ヤンヤン**、改用站內既有先例的 `You-You`（ヨウヨウ），
   否則會與同父同母的姊姊 洋洋 `yan-yan-1985-05-31` 幾乎同名。查得園方讀音須走 `tools/rename.py`。
2. **優優 `yuu-yuu-1987-07-07` 歿年 1988 → 1993**：家系圖記 `011F 優優` 在園 **1988–1993**。
   原值出自維護者提供（2026-07-28），與園方一手衝突，維護者裁定改採官方值；得年由「未滿 1 歲半」
   改為約 6 歲。精確歿日與死因仍無資料。
3. **梢 `kozue-1991-07-04` 性別 ♂ → ♀**：家系圖記 `014F`，ISB `9183` 亦記 `sex=F`（生日・出生園・
   轉入京都日逐欄吻合）。原值 ♂ 僅有 RPF #891／lineage 為據。連帶改 `aiai-1988-06-25`、
   `pin-pin-1989-06-28` 的子女表與 index。
4. **ジャスミン `jasmine-2010-07-14` 出生地更正**：家系圖記 `018F`、在園 **2013–2019** 且**無本園生
   まれ記號**，即非京都出生。月刊パンダ 京都市動物園個體表記「中国の重慶市動物園生まれ、2013 年
   3 月 30 日、中国の上海動物園から来園」。`zoos:` 由「京都 (2010-07-14 – 2019-07-25)」改為
   「Chongqing Zoo (2010-07-14 – 2013-03-30)」＋「京都市動物園 (2013-03-30 – 2019-07-25)」，
   與同批來園的 `oolong-2011-06-05` 寫法一致。
   ⚠️ **上海那一站沒有進 `zoos:`**：兩隻都只知「2013-03-30 自上海來園」、在上海的起訖日無任何來源，
   硬填會讓時間軸失真，故兩隻皆以 🚧 記於內文，查得日期後一併補。

**未命名的 8 隻不建條目**（維護者裁定，沿用既有慣例），改補進親代條目的子女表：
`oolong-2011-06-05`（+6 筆並補 配偶 ミーミー）、`jasmine-2010-07-14`（`019M`）、
`koto-2009-07-09`（`021F`／`022U`）、`mii-mii-2017-07-15`（新增 子女 段，`034F`／`035M`／`036F`）、
`mutan-2014-06-19`（同胎手足行）。2014 年兩胎的日期另有月刊パンダ 佐證；
🚧 **2023 年那一胎目前只有家系圖一個來源**，確切生日歿日待查。

其他：`an-an-1978` 補記家系圖印「アンアン」（園方一手佐證了本站讀音）、`raku-raku-1980` 補記
家系圖印「楽々」（本站維持「楽楽」）、`data/zoos.json` 京都市動物園官網由
`http://www5.city.kyoto.jp/zoo/` 改為 `https://zoo.city.kyoto.lg.jp/`。

⚠️ **家系圖的年份欄語意不一致，引用前要逐筆判斷**：多數是在園期間，但 `020M ムータン` 記
2014–2024（是歿年，實際 2015-06-10 轉出西山，有西山＋茶臼山雙佐證，wiki 不改）、
`029F ミーミー` 記 2017–（是生年，實際 2020-03-06 來園，wiki 不改）。
另 `027M`（＝`wu-tan-2018-06-21`）在官方表上**沒有名字**，「ウータン」出自 RPF。

## [2026-08-31] update | `Ai` (1991-06-20) 舊名「愛愛２」由 `japanese` 降為 `nicknames`

維護者指出。`ai-1991-06-20` 原本寫 `japanese: アイ, 愛愛２`——但 `japanese` 的多值慣例是
**同一個名字的「漢字, 假名」**，而「愛愛２」是她在広島市安佐動物公園的**舊登錄名**、
2001 年移入恩賜上野動物園後即改稱「アイ」，此後官方文書一律用新名。兩者並列在同一欄
等於把舊名當成現名的漢字寫法，實際造成兩處顯示錯誤：

- 日文介面標題顯示成全串「アイ, 愛愛２」
- **中文介面把她叫成「愛愛２」**——`extract_kanji` 從 `japanese` 取第一個純漢字詞元，
  取到的是舊名（`kanji: 愛愛２`），而 `displayName` 的中文分支是 `chinese || kanji || name`

改為 `japanese: アイ` ＋ `nicknames: [愛愛２, アイアイツー]`（原 `nicknames` 只有讀音
`アイアイツー`，舊名本體反而不在別名欄）。重建後 `kanji` 為 None，中文介面退回英文名
`Ai`、與其他純假名名字的日本個體（如 `lala-1996-08-09` ララ → Lala）一致；舊名與讀音
改在個體頁「別名」列呈現。內文原本就已寫明「原名**愛愛２（アイアイツー）**」，未動；
其他條目提及她時本來都是「アイ（原名 愛愛２）」的寫法，亦無須改。
...
## [2026-08-25] update | `banana-1996-08-09` ISB `96109` 逐欄對帳；同胎確認為ララ 一隻；補回スイカ 同胎妹妹

**維護者提問**：バナナ（安佐，1996-08-09）在 ISB 有無雙胞胎紀錄。

**對帳結果**：ISB 2008 年版 `96109` 八欄全符（♀｜9 Aug 1996｜sire `8749` 友友｜dam `8750` 明明｜`HIROSHIMA` 出生｜
名字欄 `BANANA`｜JAZGA `334C`｜終生無移動）；歿日 2013-06-06 晚於該版截止日故無記載。
**同胎為ララ `96108` 一隻**（同日同園同父母、JAZGA 連號 `333C`／`334C`）——全簿掃 `8749`×`8750` 的 11 筆後代
與安佐 1996–1997 年全部出生事件（3 筆，另一筆 `96106` 為愛愛 `8751` 所生的半血緣）皆無第三隻，含 ±1 天容許區間。
ララ（RPF #566）**目前仍無條目**（其子 `ramy-2002-07-12` 的「母」為純文字）。

**順帶修正**：2026-08-14 已在 `suika-2002-08-04` 與 `ron-ron-1995-06-30` 定案的「スイカ 非單胎」一事，
本頁與 `index.md` 漏改。

**更新條目**：

- `banana-1996-08-09.md` — 新增 `isb_checked: 2026-08-25`；引言「10 名子女均已建 wiki 條目」改為子女 11 隻（10 建檔＋1 未命名夭折）；
  新增 ✅ ISB 逐欄對帳區塊（含同胎唯一性掃查說明）；同胎手足行補「本胎僅此二隻」；
  子女表スイカ 備注「單胎」改「與 `0284` 同胎」、新增 `0284` 未命名 ♀ 一列；表末新增 🚧 母系待補佐證註記（ISB 該胎 dam 記 `UNK`）
- `index.md` — `suika-2002-08-04` 列「11 隻手足中唯一的單胎」改為同胎妹妹 `0284` 生後 3 日夭折；頁首「最後更新」改 2026-08-25；條目總數 1102 不變

**備注**：本輪不新增條目、`zoos:` 與居住史未動。ララ `96108` 建檔資格充足（名字、性別、生日、父母、居住史、歿日 ISB 皆全，
且可解掉 `ramy-2002-07-12` 的純文字母親），待維護者決定。

## [2026-08-25] add | 新建 `lala-1996-08-09`（ララ，バナナ 的雙胞胎姊妹）；13 頁「尚無條目」註記解除

**起因**：承同日 `banana-1996-08-09` 的 ISB 對帳——同胎的ララ 資料在 ISB／RPF 皆齊全，且其子
`ramy-2002-07-12` 的「母」長期是純文字懸空（網站上顯示母不詳）。維護者裁定建檔。

**來源**：
- ISB 2008 年版 `96108`（`sources/isb-red-panda/ISB-2008.txt`）
- https://redpandafinder.com/#profile/566 (Rara／ララ)

**對帳結果**：ISB `96108` 逐欄＝`F`／`9 Aug 1996`／`sire 8749` 友友／`dam 8750` 明明／`HIROSHIMA Birth`／
`TOYAMA Z 7 Aug 1998 Transfer`（局番 `4036`）／`30 Dec 2005 Death`（`Unknown means`）／`JAZGA 333C`／`styani`。
RPF #566 的 `birthday`／`death`／`gender`／`studbook.id`／兩站居住史全數吻合，且 `litter` 欄記 `232`（＝バナナ）、
`children` 欄僅 `613`（＝ラミー）——子女只有一隻，ISB 掃 `dam == 96108` 亦僅 `0278` 一筆。

**新增條目**：

- `lala-1996-08-09.md` — ララ（RPF #566／ISB `96108`），♀，1996-08-09 生於広島市安佐動物公園、
  1998-08-07 移居富山市ファミリーパーク、2005-12-30 歿（享年 9 歲）。父友友 `8749`／母明明 `8750`、
  同胎バナナ、配偶トミー `9596`、獨子ラミー `0278`。主名採 `Lala`（ISB／RPF 主名為 `Rara`，
  依站內既有四隻ララ 的慣例，`Rara` 入 `english_variants`）

**更新條目**：

- `ramy-2002-07-12.md` — 引言與家族段的「母：Rara」純文字改為 wikilink，父亦補連結；移除「父母等非本批成員暫以純文字記錄」的註記
- `tomy-1995-06-24.md` — 家族段新增「配偶」行
- `banana-1996-08-09.md` — 同胎手足行改 wikilink、去掉「尚無條目」
- `mei-mei-hiroshima.md`／`yuu-yuu-1983.md` — 子女表的ララ 列改 wikilink、去掉「尚無條目」
- `ai-ai-1984.md`／`yuu-yuu-1983.md`／`sachi-1995-07-15.md` — 愛愛「第 14 名子女」段落提及的 RPF #566 補上條目連結
- 另 13 檔的「同父異母手足（友友 × 明明）」行 — ララ 由純文字改 wikilink（`fuu-fuu-1991-06-29`／`kazu-1995-07-14`／
  `kiki-1992-07-20`／`kun-kun-1993-07-17`／`mu-mu-1988-07-14`／`ren-ren-1992-07-20`／`rin-rin-1993-07-17`／
  `sachi-1995-07-15`／`sei-sei-hiroshima`／`shin-shin-1988-07-14`／`sho-sho-1994-07-22`／`tan-tan-hiroshima`／`ten-ten-1991-06-29`）
- `index.md` — 安佐動物公園重慶來源始祖區塊新增ララ 一列；條目總數 1102 → 1103

**待裁定**：🚧 **`ramy-2002-07-12` 的 2004-03-01 移入園兩說**——ISB 記 `HIGASHI M`，該代碼在全簿另指向
`toro-2004-06-29`／`lala-2004-06-29` 等**埼玉県こども動物自然公園**（東松山市）出生的個體；現行條目依 RPF
記為**大崎公園**（さいたま市）。日期一致、只有園別不同，模式與姫路兩座園的 RPF 張冠李戴雷同。本輪未改該頁。

**備注**：`gen_residence.py` 已在本機重跑（1103 檔）；`tools/verify.sh` 通過。DB／JSON 由 CI 於 push 時重建，不需本機回寫。

---

## [2026-08-25] add | ZooMontana Pabu × Pavitra 一家四隻（讀者回報＋RPF #1417）

**來源**：

- https://redpandafinder.com/#profile/1417 (Pavitra)
- https://sandiegozoowildlifealliance.org/pr/redpandcub2023 — San Diego Zoo Wildlife Alliance 新聞稿（2023-07，出生公告「first cub born at the San Diego Zoo in almost 2 decades」）
- https://sandiegozoowildlifealliance.org/pr/redpandacubnamed — 同上（2023-09，命名公告，明載「Pavitra was born June 9 to first-time parents Adira and Lucas」）
- https://www.zoomontana.org/animals/red-panda — ZooMontana 官網動物頁
- https://www.instagram.com/zoomontana/p/C9phVElIOdm/ — ZooMontana 官方 IG（2024-07-20 到園公告）
- https://www.aza.org/connect-stories/stories/zoomontana-red-pandas-pabu-and-pavitra-become-first-time-parents — AZA Connect（2025-08-21，雙胞胎生於 6/25）
- https://www.ypradio.org/regional-news/2026-08-10/zoomontana-welcomes-red-panda-cubs — YPR（2026-08-10，2026-07-11 第二胎）
- 讀者回報（ZooMontana 官網＋官方 IG 連結，2026-08-25）

**新增條目**：

- `pavitra-2023-06-09.md` — Pavitra（RPF #1417），♀，2023-06-09 生於サンディエゴ動物園、2024-07-20 移居 Zoo Montana。父 `lucas-2020-06-23`／母 `adira-2020-07-14`，配偶 `pabu-2020-06-18`，子女 `pandora-2025-06-25`・`petunia-2025-06-25`
- `pabu-2020-06-18.md` — Pabu（RPF #1188），♂，2020-06-18 生於 Oregon Zoo、2021-03-07 隨母 Mei-Mei（#469）移居 Zoo Montana。⚠️ 與既有 `pabu-2013-07-02`／`pabu-2016-06-07` 同名不同隻
- `pandora-2025-06-25.md` — Pandora（RPF #1452），♀，2025-06-25 生於 Zoo Montana，`petunia-2025-06-25` 之雙胞胎
- `petunia-2025-06-25.md` — Petunia（RPF #1453），♀，2025-06-25 生於 Zoo Montana，`pandora-2025-06-25` 之雙胞胎

**更新條目**：

- `adira-2020-07-14.md` — 子女行由「Pavitra（#1417，父不詳 🚧，無條目）」改為條目連結並確認父為 `lucas-2020-06-23`（依 San Diego Zoo 命名新聞稿「first-time parents Adira and Lucas」，🚧 解除）；新增配偶行；`sources` 補園方新聞稿
- `lucas-2020-06-23.md` — 同上；子女表補條目連結與另一方親本；新增配偶行
- `index.md` — 新增「海外個體（美國・ZooMontana Pabu × Pavitra 一家）」一節共 4 列；Adira／Lucas 兩列說明補 Pavitra 連結；條目總數 1103 → 1107
- `tools/build_db.py` — `OFFICIAL_IG_ACCOUNTS` 新增 `zoomontana`（zoomontana.org 頁首／頁尾 IG 連結指向此帳號，到園公告發於此）

**⚠️ 回報值與採用值的差異（三處）**：

1. **生日**：回報與 ZooMontana 官網記 `2023-06-01`，本站採 **`2023-06-09`**。出生園 San Diego Zoo Wildlife Alliance 的命名新聞稿明寫「born June 9」，RPF #1417 亦記 `2023/6/9`；ZooMontana 官網為收容園日後撰寫的簡介，權重低於出生園當時的一手新聞稿。差異已記入 `pavitra-2023-06-09` 的備注。
2. **出生園名**：回報寫 `San Diego Zoo`，`data/zoos.json` canonical 為 `サンディエゴ動物園`（`San Diego Zoo` 為 alias），frontmatter 依註冊表寫 canonical。
3. **移入日**：回報 `2024-07-20` 與官方 IG 公告日一致、予以採用，惟貼文用語為「recently came to us」，實際抵園可能早於公告日數日；RPF 記 `2024/11/1` 但其自身 `uncertainty` 欄即標 `location.2 exact date`，與官方公告矛盾故不採用。

**未建檔（待補）**：Pavitra × Pabu 於 **2026-07-11** 再產一胎（YPR 2026-08-10 報導，連續第二年繁殖），胎數／性別／名字未確認、RPF 亦尚未建檔，暫未建蘋果籽佔位條目。Pabu 之父母 Moshu（#413）與 Mei-Mei（#469）僅有 RPF 線索、無官方佐證，亦未建檔。

## [2026-08-25] update | 讀者回報：ララ 的安佐時期旧名為リンゴ（`lala-1996-08-09` 補 japanese 多值＋三筆參考資料）

**讀者回報**（2026-08-25，同日建檔後隨即回報）：ララ「原名リンゴ」，並附三個連結。逐項核對結果：

| 回報項 | 核對 | 處置 |
|---|---|---|
| 原名リンゴ | 同好粉專與安佐家系図掲示實拍兩份同好來源支持 | ✅ 採用，`japanese: ララ, リンゴ` |
| 性別♀／父友友／母明明／雙胞胎バナナ | 與 ISB `96108` 一致 | ✅ 已在條目 |
| 生日 1996-08-09／歿 2005-12-30 | 與 ISB／RPF 一致 | ✅ 已在條目 |
| 出生園「広島県安佐動物園」 | 正式名為広島市安佐動物公園 | 沿用正式名 |
| 移動日期不詳→推測 1998-08-24（同トミー） | ❌ ISB 逐隻有日期：本隻 `TOYAMA Z 7 Aug 1998`（局番 `4036`）、トミー `24 Aug 1998`（局番 `4037`） | 不採用，維持 1998-08-07 |

**假名寫法**：來源寫平假名「りんご」，條目採片假名 `リンゴ`——比照同園同樣「來園改名」的 `hana-2005-06-21`
（`japanese: ハナ, ヒマワリ`，來源同樣寫「ひまわり」）之既有寫法。

**來源分級**：三筆全部歸 `extra_sources`，**沒有一筆是園方一手**——
① FB「レッサーパンダをこよなく愛する会」2016-07-26（**同好粉專、不是富山市ファミリーパーク 官方**，
故不列入 `OFFICIAL_FB_PAGES`）；② 豆パンダ部落格 2014-07-28〈14.07 家系図〉安佐家系図掲示實拍；
③ jillluca 4travel 2014-08-14（佐證「一粒種」＝獨子）。富山官網與官方 SNS 查無本隻介紹頁。
⚠️ 該 FB 貼文把園名誤寫成「富士市ファミリーパーク」（正確為富山市），引用時勿照抄。

**更新條目**：

- `lala-1996-08-09.md` — `japanese: ララ` → `ララ, リンゴ`；H1 改「Lala（ララ / リンゴ）」；引言補旧名與水果名成對的來由；
  新增 `extra_sources` 三筆；備注新增「旧名リンゴ」與「移居富山不與トミー 同日」兩條；
  既有的ラミー 移入園 🚧 補上兩份同好來源都寫大崎公園、以及「貸し出し（出借）＝ISB 可能記登録機構」的假說

**待裁定（都在 `ramy-2002-07-12`，本輪未動該頁）**：

1. 🚧 2004-03-01 的移入園：ISB `HIGASHI M`（埼玉県こども動物自然公園）vs 大崎公園（RPF＋兩份同好來源）
2. 🚧 返回富山的日期：現行 2010-02-12（RPF）vs FB 粉專的「2010年3月12日」
3. 可補的細節（皆出自該 FB 貼文）：名字由來「ララ」＋「トミー」＝「ラミー」；本隻為富山市ファミリーパーク
   首次成功繁殖的小熊貓（該園 1998 年起投入繁殖）；埼玉時期與長野來的キキ 同居；返園後與 `hana-2005-06-21` 配對

## [2026-08-25] update | `lala-1996-08-09` 旧名表記改採掲示的「リンコ」（維護者判讀），三筆讀者回報來源已列 `extra_sources`

**維護者判讀**（2026-08-25）：豆パンダ部落格 2014-07-28〈14.07 家系図〉那張**広島市安佐動物公園家系図掲示**的實拍，
圖中寫的是清音**「リンコ」**（該圖與該網域在本工作階段被瀏覽器擴充功能的安全限制擋住、Claude 無法自行判讀，由維護者代讀）。
同好粉專 FB 則寫濁音「りんご」，兩者差一個濁點。

**處置**：`japanese: ララ, リンコ, リンゴ`（兩種表記都進多值欄＝搜尋鍵，任一拼法都查得到）；
H1 與引言主表記採掲示的 `リンコ`；備注改寫成並列兩份佐證＋🚧 濁點未定（若為リンゴ 則與雙胞胎バナナ 成水果名對）。

**來源歸屬**：讀者回報的三個連結全部列在 `extra_sources`（同好來源，非園方一手）——
FB 粉專貼文（旧名與改名）、豆パンダ部落格（安佐家系図掲示實拍）、jillluca 4travel（佐證獨子）。

**備注**：`sources:` 維持 ISB 與 RPF 兩筆不動；`zoos:`、生卒、家系皆未變動。

---

## [2026-08-25] add | ZooMontana 2026 年第二胎蘋果籽 2 筆（官方 IG 公告）

**來源**：

- https://www.instagram.com/zoomontana/p/Db3ZJuvDDHi/ — ZooMontana 官方 IG（2026-08-10 出生公告）：「On July 11th, red pandas Pavitra and Pabu welcomed two new cubs into the world!」
- https://www.ypradio.org/regional-news/2026-08-10/zoomontana-welcomes-red-panda-cubs — YPR（同日）
- https://nbcmontana.com/news/local/zoomontana-welcomes-red-panda-cubs-to-the-world — NBC Montana（同日）

**新增條目**：

- `apple-seed-1-pavitra-2026-07-11.md` — 蘋果籽1號，2026-07-11 生於 Zoo Montana，母 `pavitra-2023-06-09`／父 `pabu-2020-06-18`
- `apple-seed-2-pavitra-2026-07-11.md` — 蘋果籽2號，同胎雙胞胎

**蘋果籽四項資格逐項核對**（`CLAUDE.md`〈當季寶寶佔位條目〉）：

| 條件 | 核對結果 |
|------|---------|
| 父母皆已確認 | ✅ Pavitra × Pabu，兩隻均已建檔（本日同輪新增） |
| 生日已確認（完整 YYYY-MM-DD） | ✅ 2026-07-11，園方官方 IG 明載 |
| 尚在世 | ✅ 公告日（2026-08-10）將滿一個月、眼睛開始睜開、胎毛轉紅褐色 |
| 尚未正式命名 | ✅ 公告未命名、亦未公布性別；RPF 尚未建檔 |

**更新條目**：

- `pavitra-2023-06-09.md`／`pabu-2020-06-18.md` — 子女行拆成「2025 年第一胎」與「2026 年第二胎」兩行；引言與備注改寫（原記「2026 年第二胎尚未建檔」）
- `pandora-2025-06-25.md`／`petunia-2025-06-25.md` — 新增弟妹行
- `index.md` — ZooMontana 一節新增 2 列、敘述段補第二胎；條目總數 1107 → 1109

**備注**：`sex` 依規則留空、tags 不加性別 tag、性別欄寫「？」。**序號 1／2 為任意指定**——園方公告未區分兩隻、RPF 無 ID 可排序，`CLAUDE.md` 規定的兩種排序依據皆不存在，已寫入兩筆條目的備注段，待園方公布個體識別或命名時釐清。

## [2026-08-25] fix | 🐛 `build_db` 從不認得「同胎…：」標籤 → 四對雙胞胎在網站上不存在；check_twins 補反向不變量 E4

**維護者提問**：「為什麼 banana 頁面沒有呈現這是雙胞胎？少了什麼？」

**病因**：`tools/build_db.py` 的 `parse_family()` 只用 `^-\s*[二兩雙三四五六]胞胎[^：:]{0,4}[：:]`
抓多胞胎行。**「- 同胎手足：」「- 同胎：」「- 同胎兄弟：」完全不匹配**，行內的 wikilink 因此
從未進 `twins` 表 → 個體頁不顯示「雙胞胎」列、家系圖也沒有那條邊。條目正本寫得好好的，
壞在解析器；`audit.py` 與 `check_twins.py` 都不會察覺（check_twins 用同一支解析器建同生群，
根本形不成群，自然沒東西可稽核）。

**受害的四對**（同父同母、同日出生，網站上卻互不相干）：

| 配對 | 標籤寫法 |
|---|---|
| `banana-1996-08-09` × `lala-1996-08-09` | 兩邊都寫「同胎手足：」 |
| `pandora-2025-06-25` × `petunia-2025-06-25` | 兩邊都寫「同胎手足：」 |
| `ran-ran-1987-07-26` × `you-you-1987-07-26` | 兩邊都寫「同胎手足：」 |
| `lili-1986-07-05` × `tan-tan-1986-07-05` | 寫成「手足：…（同日出生）」，連 `同胎` 都沒有 |

**修正**：

- `tools/build_db.py` — 多胞胎正則改為 `^-\s*(?:[二兩雙三四五六]胞胎|同胎)[^：:]{0,6}[：:]`，
  涵蓋 同胎／同胎手足／同胎兄弟／同胎第三隻／同胎第四隻。無 wikilink 的註記行（「同胎手足：無」、
  「同胎第三隻：（無名）…未建條目」）照樣抓不到東西，無副作用。實測配對 293 → 297 組、
  同生群 259 → **263 組**（雙胞胎 238 → 242），新增的正好是上表四對、其餘一組不多不少
- `tools/check_twins.py` — **新增 E4 反向不變量**：同父同母且生日相差 ≤1 天、卻不在同一同生群 → 報錯
  （同一隻母獸不可能隔一天生兩胎，故必為漏標或標籤沒被解析）。這條才是真正的防呆：
  日後再出現任何寫法沒被解析的情況，CI 會直接擋下而不是靜靜漏掉
- `wiki/lili-1986-07-05.md`／`wiki/tan-tan-1986-07-05.md` — 「手足：…（同日出生）」改為明確的
  「- 同胎手足：」；tan-tan 原本一行混列同胎的麗麗與非同胎的蘭蘭／陽陽，已拆成兩行

**備注**：本輪不動任何生卒／居住史／親子資料。修正後 `check_twins` 0 錯誤 0 警告、`audit --strict` 🔴 0。
DB／JSON 由 CI 於 push 時重建，屆時四對關係即會出現在個體頁與家系圖。

## [2026-08-25] update | `ramy-2002-07-12` 埼玉時期定案：ISB 記登録機構、wiki 記實際所在地

**維護者裁定**：「小熊貓的擁有者跟實際展示的不同——例如雖然風太是在千葉，但他的歸屬始終是日本平。」

據此，ISB `0278` 的 `HIGASHI M`（埼玉県こども動物自然公園）與 RPF／同好來源的大崎公園**不衝突**：
前者是所有權／登録上的持有機構，後者是實際展示地。**本 wiki 的 `zoos:` 一律記實際所在地**，
既有先例為 `hajime-1991-07-27`（1994 年由釧路市動物園出借鹿児島市平川動物公園，條目記平川）。

**更新條目**：

- `ramy-2002-07-12.md` — 新增 `## 備注` 三條（埼玉時期的登録機構 vs 展示地裁定、🚧 返園日期兩說、名字由來
  「ララ」＋「トミー」＝「ラミー」與富山首次繁殖成功）；frontmatter 新增 `extra_sources` 兩筆（FB 同好粉專、jillluca 4travel）
- `lala-1996-08-09.md` — 原本的 🚧 待覆核條改寫為已裁定，居住史與 `zoos:` 均不動

**待查**：🚧 ラミー 返回富山的日期，現行 2010-02-12（RPF）vs FB 粉專「2010年3月12日」。

## [2026-08-25] update | `ramy-2002-07-12` 返回富山日期改採 2010-03-12（維護者裁定）

**維護者裁定**：返園日採 **2010-03-12**。舊值 2010-02-12 出自 RPF；同好粉專 FB
「レッサーパンダをこよなく愛する会」2016-07-26 的【レッサーパンダ紹介】逐條列出三次移動，
第三條寫「2010年3月12日　富山県富山市ファミリーパークへお引越し」，兩者只差月份（2↔3）。

**更新條目**：

- `ramy-2002-07-12.md` — `zoos:` 兩段改為 `大崎公園 (2004-03-01 – 2010-03-12)`／
  `富山市ファミリーパーク (2010-03-12 – 2016-11-01)`；居住史表由 `gen_residence.py` 重生；
  備注的 🚧 兩說條改寫為裁定紀錄（並保留「尚無園方一手佐證、日後可覆核」的但書）
- `lala-1996-08-09.md` — 備注中提及該日期未定的那句改為已裁定

**備注**：至此 `ramy-2002-07-12` 本輪的三個待決項全部收束——① 埼玉時期的登録機構 vs 展示地
（ISB `HIGASHI M` 為登録持有機構、`zoos:` 記大崎公園）② 返園日 2010-03-12 ③ 名字由來等細節已補進備注。
`gen_residence.py`（1109 檔）與 `tools/verify.sh` 皆通過。

## [2026-08-26] fix | アーヤ／アーニャ ISB 覆核：兩隻逐欄全對，`a-ya` 引言序數第三、四女 → 第四、五女

維護者要求覆核 `a-ya-1998-07-03`／`a-nya-1998-07-03` 這對雙胞胎的 ISB。

**逐欄全對（兩筆）**：`98031`／`98032` 皆 `F`、`3 Jul 1998`、`sire 9493`（宝宝）／`dam 9172`（香）、
`MITO CHO Birth`（秋吉台）、`styani`，局番分別 `JAZGA 379C`／`380C`，事件列各只有 `Birth` 一行、死亡欄空白
（2012-12 轉入日本平與 2016 年歿日均在該版資料截止日 2008-12-31 之後，非缺漏）。
同輪反查 `sire 9493`／`dam 9172` 仍是 7 筆、掃 `MITO CHO` 1997–1999 全部出生事件亦無第三隻同胎，
`98031`／`98032` 之外**沒有漏收的手足**。

**⚠️ 一處誤述（本輪唯一改動）**：`a-ya-1998-07-03` 引言的「七隻子女中的第三、四女」——
2026-08-24 那輪補入的 `97103`（♀、1997-07-01 生、當日夭折、`fuuko-1997-06-30` 之同胎）依生日排在她們之前，
兩姊妹實為**第四、五女**（ノン → 風子 → `97103` → アーヤ → アーニャ）。
該輪把「六姊妹」改成「七隻子女」時只改了母數、漏改序數。
→ 維護者裁定序數含 `97103`（與 `kaori`／`bau-bau` 兩頁的「7 隻子女」口徑一致），已改，並在備注留記。
同 `superlative-claims-need-isb-sweep` 的教訓延伸：**新增手足後要回頭掃全庫的序數／最高級敘述**，
不是只改總數。（掃過 `a-nya`／`non`／`fuuko`／`riku`／`miku`／`kaori`／`bau-bau`／`index.md`，其餘敘述均正確。）

**維持不動**：

- `98032` ↔ アーニャ 的對應仍標 🚧——ISB 這一胎兩筆除局番外完全相同，登録簿本身分不出誰是誰
  （姊姊的 `98031` 出自 2026-08-09 全庫補號那輪的 RPF `studbook.id`；維護者裁定不寫進備注）
- 🚧 轉入日本平的日期兩說（`a-ya` 2012-12-12／`a-nya` 2012-12-02）：ISB 收錄截止在前，無法裁定，維持待查
- 「歿時為國內最高齡雌性」出自日本平飼育日誌，ISB 版本止於 2008 年、無從佐證，措辭不動

**更新條目**：`a-ya-1998-07-03.md` 一檔（引言序數＋備注新增序數更正一條）。frontmatter 未動。

## [2026-08-26] fix | アーヤ／アーニャ／スミレ 轉入日本平的日期統一為 2012-12-13（園方紹介牌＋飼育日誌）

承前一筆的 ISB 覆核。維護者追問アーニャ 的轉園日，查證後三隻同批個體的日期全部更正。

**定案依據（園方一手）**：

1. **園方展示紹介牌**載「秋吉台　2012年12月13日来園」（維護者提供；照片見 2013-01-26 的 4travel 旅記）
   → `a-ya-1998-07-03`／`a-nya-1998-07-03` 定為 **2012-12-13**
2. **日本平動物園飼育日誌 2012-12-13**：「スミレ（♀）周南市徳山動物園より来園する。検疫後レッサーパンダ館に展示予定。」
   → `sumire-2011-07-12` 由 2012-12-12 改為 **2012-12-13**（官方來源可直接採用）
3. 同旅記本文「１２月１３日、山口県の２園から３匹のパンダが異動してきました」——三隻＝アーヤ・アーニャ（秋吉台）＋スミレ（徳山），
   與飼育日誌同日、互相印證

**舊值全部無源**：`a-ya` 的 2012-12-12 與 `sumire` 的 2012-12-12 都出自 2026-06 匯入那批、`sources` 只有 RPF，
而 RPF 的 `edges` **不帶日期**、給不出搬園日（同 コウタ／リリィ 2015-05-01 那次的教訓，見 2026-08-15 該筆）；
`a-nya` 的 2012-12-02（2026-08-02 維護者提供）研判為 12-12 之誤植。
がちょん 部落格〈アーニャ　ありがとうね〉（2016-06-10）記「秋吉台から2012年12月12日にアーヤちゃんと一緒に日本平へ移動」，
研判為出發日、且屬同好記載，收進 `extra_sources` 備考、不作為居住史依據。

**查過但無法佐證**：日本平飼育日誌 2012 年 12 月的「来園」僅 4 件（12-13 スミレ、12-13 ポンキチ、12-20 オナガカエデチョウ、
12-24 オオサンショウウオ 的回顧提及），**兩姊妹的搬入日誌根本沒記**；關鍵字「秋吉台」全期間 0 件。
兩姊妹在日誌最早出現於 12-17（與雄性相親），只能把抵達日壓在該日以前——故園方日誌本身不能單獨定案，靠的是紹介牌。

**更新條目**：

- `a-ya-1998-07-03.md`／`a-nya-1998-07-03.md` — `zoos:` 兩段日期改 2012-12-13、居住史表由 `gen_residence.py` 重生；
  `sources` 加「維護者提供（2026-08-26：園方展示紹介牌照片…）」、`extra_sources` 加がちょん 與 4travel 兩篇；
  原「⚠️ 兩說待查證」備注改寫為定案紀錄；`a-ya` 的 ISB 對帳段順手改掉「日期落差 ISB 無法裁定」一句
- `sumire-2011-07-12.md` — `zoos:` 兩段日期改 2012-12-13、居住史重生；`sources` 補飼育日誌（關鍵字「スミレ」）；
  引言補來園日與同批三隻的敘述；新增 `## 備注` 記此次更正

**備注**：`98032` ↔ アーニャ 的 🚧 不受影響（仍無法由 ISB 分辨）。`gen_residence.py`（1109 檔）與 `tools/verify.sh` 皆通過。

## [2026-08-26] update | 美美 ISB `8536` 逐欄對帳：⭐ 牠 1987 年在茶臼山生過一仔（`8754`），wiki 從未收錄

維護者要求核對 `mi-mi-1985-06-12` 的 ISB。本隻＝ISB `8536`，
`F`／`12 Jun 1985`（非推定值）／`dam 8535`（花花）／`styani`／`JAZGA 028C`／名字欄空白，
事件＝`NAGANO 12 Jun 1985 Birth ｜ NIHONDAIR 20 Oct 1988 Transfer ｜ 11 Jun 2003 Death`（死因 `Old age`）。
性別・生日・亞種・母・出生園・歿日全部相符，居住史兩站之間無中繼園遺漏。

**⭐ 新發現：`dam == 8536` 有 1 筆——ISB `8754`**，♂／`1987-06-20` 生於 `NAGANO`／`1987-06-22` 歿（生後 2 日）／
`sire 8534`（誼誼）／`JAZGA 051C`。原條目寫「未留下子女」，實際上牠在移居日本平之前、
兩歲那年於茶臼山產過一胎。依〈幼逝寶寶收錄原則〉未命名不建條目，只寫進父母雙方子女表
（`| (無名) 🪽 |` 起頭，不長親子邊）。同胎僅此一隻。
花花 5/31 生雙胞胎、美美 6/20 生一仔——1987 年茶臼山其實是兩胎，母獸不同，不是同一批。

**父欄 `UNK` 的意義（沿用 `hoa-hoa-1982-06-15` 2026-08-12 的發現，補寫進本頁）**：
花花與誼誼 1985-03-19 同日入園、美美 6/12 出生，中間 85 天短於妊娠期（約 114–145 日），
花花係懷孕來日、生父為石家莊未登録的雄性，故 ISB 記 `UNK`。連帶兩點寫進條目：
①與 `yuu-yuu-1987-05-31`／`genki-1989-06-30` 的「全血緣」改記為研判；
②`8754` 是否父女近親同樣取決於此，照 ISB 自身記載則不是。

**入園日不改**：ISB 記 `NIHONDAIR 20 Oct 1988`（與 RPF 同值），本條目 2026-08-10 已依園方刊物
《ズーしずおか》84 号改採 **1988-10-19**。ISB 的日本國內轉園日期本就是園方回報值、精度不優於園報，維持官方一手優先。
順手把 `hoa-hoa-1982-06-15` 子女表裡仍寫著 1988-10-20 的那一格改成 10-19（站內原本兩頁不一致）。

**更新條目**：

- `mi-mi-1985-06-12.md` — 補 `isb_checked: 2026-08-26`、`sources` 加 ISB；引言補 1987 年那一胎；
  新增「### 子女（父：`i-i-1983` 誼誼，共 1 隻）」表＋名單完整性註記；父欄的 🚧 改寫為 `UNK` 與懷孕來日的說明
- `i-i-1983.md` — 配偶加美美；新增「### 子女（與 `mi-mi-1985-06-12` 美美所生，共 1 隻）」表；
  註明 ISB `sire == 8534` 的 6 筆與花花表的「6 隻」不是同一組（一邊算進美美本人、一邊算進美美的仔）
- `hoa-hoa-1982-06-15.md` — 美美那列的移入日 10-20 → 10-19，備注補孫輩 `8754`；`UNK` 那段註記補對帳完成

## [2026-08-26] add | あゆみ・ハジメ 之母得名「かあさん」＝ISB `8849`，建檔 `kaasan-1986`

維護者提供一筆待查個體（かあさん／♀／雙親 wild／子女＝平川はじめ・釧路あゆみ），要求核對 ISB 有無對應紀錄。
**結論：即 ISB `8849`**，逐欄相符——`F`／`~ 1986`（推定）／`sire WILD`・`dam WILD`／`styani`／`JAZGA 079C`／名字欄空白，
事件＝`CHINA ???? NONE Capture ｜ KUSHIRO Z 25 Jun 1988 Transfer ｜ NIHONDAIR 5 Feb 1997 Transfer ｜ 18 Mar 2001 Death`
（死因分類 `Other/Unknown｜Digestive｜New growths/cancer`）。掃全表 `dam == 8849` 恰為 `9191`（`HAJIME`）與
`9192`（あゆみ）兩筆，與維護者提供的子女名單完全一致，是身分認定的關鍵錨點。

本隻此前已知、但因 ISB 名字欄空白且無名字來源而未建條目，僅以 `mother_ref: "isb:8849"` 記於兩隻子女
（2026-08-19 釧路一家對帳時登記）。今得名故改建為條目。

**⚠️ 生日不採維護者提供的 1996-02-05**：ISB 全簿 1996 年 2 月無任何出生紀錄，釧路該年只有 `9696`／`9697`
（1996-07-09）一胎；且本隻 1991-07-27 已產下雙胞胎，不可能 1996 年生。該日期的月日與 ISB 所記
**移入日本平之日 1997-02-05 相同、僅年份差一**，研判為搬園日誤植成生日。生年改採 ISB 推定值 `~ 1986`，
slug 依 SCHEMA〈野生／來源不明出身個體〉作 `kaasan-1986`（比照 `taisyu-1987`）。

**名字出處待補**：查過一輪無線上佐證——ISB 名字欄空白、釧路市動物園官網個體介紹只列 2004 年以後來園者、
日本平飼育日誌以「かあさん」搜尋 0 件。故 `sources` 記 `維護者提供（2026-08-26）：名字「かあさん」`，
條目內標 🚧 待補一手出處（釧路記念誌《あゆみ》或園內展牌）。

**來源**：
- https://web.archive.org/web/20120128200628/http://www.rotterdamzoo.nl/import/assetmanager/2/6732/Red%20Panda%20Studbook.pdf （ISB 2008 年版，番號 8849）
- 維護者提供（2026-08-26）：名字「かあさん」

**新增條目**：
- `kaasan-1986.md` — Kaasan かあさん（ISB `8849`），推定 `~1986` 年生於中國（野生捕獲），
  1988-06-25 入釧路市動物園、1997-02-05 移静岡市立日本平動物園，2001-03-18 歿；`isb_checked: 2026-08-26`

**更新條目**：
- `ayumi-1991-07-27.md`／`hajime-1991-07-27.md` — 母行由「無名個體（ISB `8849`…）」改為 `kaasan-1986` 的 wikilink、
  移除 `mother_ref`（父 `8930` 仍無名字來源，`father_ref` 保留）；備注各補一段得名建檔的註記
- `index.md` — 「Ikura × Tan-Tan 一脈」新增 `kaasan-1986`；該小節前言補上一代母獸，並解除已由 ISB
  佐證的「🚧 親子關係待查證」（あゆみ × サバタロウ，2026-08-19 已定案）；條目總數 1109 → 1110

## [2026-08-26] update | 「かあさん」是園方登記的名字（日本平園報六期佐證），非「母親」之泛稱

維護者對本日稍早建的 `kaasan-1986` 提出疑問——「かあさん」看起來像日文的「媽媽」、可能不是名字——並提供
日本平動物園園報〈でっきぶらし〉兩篇連結。循該線索檢索園報全文庫（關鍵字「釧路」19 件・「かあさん」21 件・
「カアサン」3 件）逐篇核對，**確認是個體名**：

- **115 号（1997-01）4 頁〈レッサーパンダ メス来園〉**：「名前は『かあさん』（１回繁殖している）」
  「このメスは８才」「ブリーディングローン、移動の手続きを済ませ、２月５日に来園しました」
  「２月１１日にパンダ舎に移し、オス１頭メス２頭の生活が始まりました」
- **124 号（1998-07）1 頁〈レッサーパンダの繁殖は幻に・・・〉**：「釧路動物園より♀１頭（**名前はカアサン**）を
  借り受け」「シンシンとカアサンの間で交尾が見られ」
- 116 号（1997-03）動物病院だより／127 号（1999-01）友の会コーナー／148 号（2002-07）シンシン訃報 亦以
  かあさん／カアサン 稱之。園報片假名與平假名兩種寫法並用 → `japanese: かあさん, カアサン`

**⚠️ 1996-02-05 之說的來源找到了**：120 号（1997-11）寫「昨年２月に借り受け」、124 号（1998-07）寫
「一昨年の２月」，兩筆都指向 1996 年 2 月。但 116 号（1997-03）明寫「**今年の**２月５日に釧路から、
かあさんがやって来た」，且同期記シンシン 10 才・ミミ 11 才——以兩隻生日（1986-06-23／1985-06-12）驗算
只有 1997 年 3 月成立 → 「今年」＝1997，與 ISB `NIHONDAIR 5 Feb 1997` 一致。**來園日維持 1997-02-05**，
120／124 号 判為年份（或年度）誤植，已寫進條目備注，避免日後重蹈。

**年齡另有一套推定**：園報 8 才（1997-01）→ 推定 9 才（1997-03），推回約 1988 年生；ISB 記 `~ 1986`。
兩者皆推定值，`born` 依 SCHEMA〈野生／來源不明出身個體〉維持 ISB 值、slug 不動，園報值記於備注。

**來源**：
- https://www.nhdzoo.jp/newspaper/naka.php?newspaper_uid=1160 （115 号）
- https://www.nhdzoo.jp/newspaper/naka.php?newspaper_uid=597&newspaper_num=244 （116 号）
- https://www.nhdzoo.jp/newspaper/naka.php?newspaper_uid=1106&newspaper_num=286 （120 号）
- https://www.nhdzoo.jp/newspaper/naka.php?newspaper_uid=1077 （124 号）
- https://www.nhdzoo.jp/newspaper/naka.php?newspaper_uid=1017 （127 号）
- https://www.nhdzoo.jp/newspaper/naka.php?newspaper_uid=1509&newspaper_num=211 （148 号）

**更新條目**：

- `kaasan-1986.md` — `japanese` 補カアサン；`sources` 由「維護者提供」改為園報六期（皆官方一手，
  行末註記號數與原文引用）；名字那段 🚧 改為 ✅；新增日本平時期敘述（ブリーディングローン、與シンシン
  相性不佳、1998 年交尾未產仔、缺一顆牙）、來園日誤植與年齡兩說的備注
- `shin-shin-1986-06-23.md` — 配偶補 `kaasan-1986`；內文補 1997 年迎入かあさん 至 2001 年先歿一段；
  `sources` 加 124 号
- `ayumi-1991-07-27.md`／`hajime-1991-07-27.md` — 母獸得名那段註記改記園報佐證（原寫「維護者提供」）
- `index.md` — かあさん 該列補カアサン 與「1997 年出借日本平」

## [2026-08-26] fix | `sources` 行末說明文字 3 檔（連結會壞掉）；掃描法補上「全形括號」變體

建 `kaasan-1986` 時又踩到「`sources:` 不吃行末註解」（第四次），順手全庫回掃。
`sources` 的值原封不動進 DB、`Panda.astro` 直接 `href={u}` → 說明文字會連著 URL 被當成連結，個體頁該筆點不開。

**⚠️ 舊掃描法漏抓**：以往只找 `  #` 開頭的 YAML 註解，**漏掉用全形括號寫在 URL 後面的**（無 `#`）。
新判準：`sources` 陣列裡任何以 `http` 開頭、卻含空白或中日文字元的值都算。掃完現況 **0 筆**。

**更新條目**：

- `dr-wallace-2025-06-03.md` — `capemaycountynj.gov` 那行剝掉 `# Cape May County 郡府新聞稿…`；
  新增 `## 備注` 記其為郡府新聞稿、該園郡營（`.gov` 規則自動判官方）
- `da-lian-liuzhou.md` — `xhslink.com` 那行剝掉全形括號說明；新增 `## 備注` 記訃告出處
- `han-han-liuzhou.md` — 同上；備注另記「來園日期與享年出自該貼文的**官方留言回覆**」；
  順手把 `sources` 的「作者提供」改為「維護者提供」（稱呼慣例）

三檔 `has_official_source` 皆維持 true。`verify.sh` 🔴 0、check_twins 0 錯誤。

## [2026-08-26] fix | 維護者裁定：美美 `8536` 的父改記「不詳」，誼誼子女 6→5

承同日 `mi-mi-1985-06-12` 的 ISB 覆核。維護者追問「為什麼認定誼誼是父親」，追出處後裁定改為**父不詳**。

**舊值站不住的理由**：

1. 唯一依據是 RPF／redpanda-lineage `#768` 的 `children: 762, 763, 764, 765, 766, 767`——
   **整段連號一次掛給誼誼**（同資料集裡花花 `#761` 的 `children` 也以同一段開頭），是整批推定不是逐胎紀錄；
   該資料集還把兩隻都記成野生出身、誼誼生日 unknown，只有線索級效力
2. **維護者 2026-07-29 提供的名單只有姓名・所屬園・性別**（見本檔該筆），沒有父方；
   `hoa-hoa-1982-06-15` 2026-08-12 那句「維護者提供」與此對不上
3. ISB `8536` 的 `sire` 記 `UNK`，而**同一批 `8752`／`8753`／`8839`／`8840`／`8920` 全部明寫 `8534`**——
   不是那個年代沒收父方，是這一筆特別
4. `sire UNK` 全簿 2,703 筆中只有 **12 筆**，且有清楚規律＝母獸帶孕入園：
   `8536`（母花花 入園後 85 天生）／`8533`（母蓉蓉 79 天）／`9489`＋`9490`（母林林 94 天），
   三組間隔都短於妊娠期（約 114–145 日）

誼誼與花花同批自石家莊來日，若在中國即已交配他仍是最可能的生父，但 ISB 對輸日中國個體連中間機構都不記，無從查證。

**更新條目（15 檔）**：

- `mi-mi-1985-06-12.md` — `父：不詳`；½ 手足行拿掉「同父 I-I ⇒ 全血緣」；🚧 註記改寫為 ✅ 裁定紀錄（含上列四點與三組同型佐證）
- `i-i-1983.md` — 花花子女表移除美美一列、標題 6→5 隻、引言「六隻」→「五隻」、檔案卡理由句去掉美美；
  ISB `sire == 8534` 的 6 筆註記改寫（現在＝花花 5 ＋ 美美所生的 `8754`，與兩張表完全一致）
- `hoa-hoa-1982-06-15.md` — 子女表美美列的 `父` 欄改 **不詳**、配偶行「誼誼…6 隻」→「5 隻」、2026-08-12 的 🚧 改為 ✅ 定案
- `index.md` — 美美列「（父 I-I）」→「（父不詳）」
- `ai-ai-1987-05-31.md`／`genki-1989-06-30.md`／`yuu-yuu-1987-05-31.md` — 美美由「全血緣兄弟姊妹」移到「½ 兄弟姊妹」並標父不詳
- `cha-cha-1993-06-27`／`maho-1991-06-06`／`min-min-1993-06-27`／`pan-pan-1994-06-17`／`ran-1992-06-21`／
  `rin-rin-1992-06-21`／`shun-1995-06-17`／`ton-ton-1994-06-17` — ½ 名單裡美美改標「（1985，父不詳）」，
  行末「以上父 I-I」改成「這兩隻／這四隻父 I-I」（原本會把美美一起涵蓋進去）

**連帶解除**：美美與誼誼所生的 `8754` **不構成父女近親**（誼誼非美美之父），該疑點作廢。

**驗證**：`tools/verify.sh` 🔴 0 / 🟡 44、check_twins 0 錯誤。親子邊只由 `mi-mi` 的 `父` 行與 `i-i` 的子女表產生，兩處已同時清掉，無「子女表單邊殘留」那種問題（見 2026-08-16 build_db 反向邊那筆）。

**追記（同日）**：clone 上游 `wwoast/redpanda-lineage` 後確認 **RPF 未收錄 `8754`**——
番號 `8754` 全庫 0 筆、`birthday: 1987/6/2x` 0 筆、`0762_mimi.txt` 的 `children: none`，三段掃法皆空。
`mi-mi`／`i-i` 兩頁的那一列已補「RPF 未收錄」。
（雲端容器可直接 `git clone` 該 repo，不必開 Chrome——查單隻與查親子關係都比 `/export/redpanda.json` 快。）

**重建（同日）**：本輪動到親子邊，已在雲端容器跑 `rebuild.sh` 並把 `redpanda.db` ＋
`pipeline/data/*.json` 寫回本機。結果：1110 個體／**1639 親子邊**／263 同生群，check_twins 0 錯誤。
覆核 `pandas.json`：`mi-mi-1985-06-12` 的 `father` 為 `None`、`i-i-1983` 的 `children` 只剩
`ai-ai-1987-05-31`／`yuu-yuu-1987-05-31`／`rei-1988-06-17`／`genki-1989-06-30` 四筆（第五隻 `8839` 無條目）。
容器裡 `gen_residence` 重生的 1110 檔與本機**逐檔相同**（diff 0），故 wiki 正本未再寫回。
暫存 tar 留在 `_to_delete/rebuild-20260826.tgz`，請自行清理。

## [2026-08-26] update | シュウシュウ ISB `01112` 逐欄對帳：⭐ 子女 4 → 10 隻（6 隻幼逝仔從未收錄），⚠️ `dam` 欄誤植再確認

維護者要求核對 `shuu-shuu-2001-07-21` 的 ISB。**本隻逐欄全對**，但掃 `sire == 01112` 挖出六隻本站從未收錄的幼逝仔。

**本隻＝ISB `01112`**：`M`／`21 Jul 2001`／`sire 8856`（周周）／`styani`／`JAZGA 464C`／名字欄 `SHYUSHU`，
事件＝`TOKUYAMA 21 Jul 2001 Birth ｜ SHIZUOKA 18 Mar 2004 Transfer`。
性別・生日・父・亞種・出生園・移居日全部相符。歿日 2015-12-27 在 ISB 資料截止日 2008-12-31 之後，無死亡列不是缺漏。

**⚠️ `dam` 欄誤植（沿用 2026-08-24 `kou-kou-2003-07-15` 那輪的結論，這次補寫進兩隻本人的條目）**：
ISB 把本隻與同胎 `01111`（トクトク）的 `dam` 都記成 `9488`。`9488` ♀ 是母親遊優（`9486`）的同胎姊妹，
1994-07-04 生於ひらかたパーク、**1994-07-07 三日齡即夭折**，不可能在 2001 年產仔；番號僅差一碼，研判 `9486` 之誤植。
母系依 RPF #373 與《どうぶつと動物園》徳山家系圖仍記遊優，**資料不改**。

**⭐ 新發現：`sire == 01112` 有 8 筆，母全是 `00103`（楢），本站原本只收 2 筆**——
`0478`（2004-07-10 生歿同日）／`0575`（2005-07-12 生歿同日，死因記同居個體咬傷）／
`0677`（2006-07-04 生、07-10 歿，得年 6 日）／`0776`・`0777`（2007-07-19 同胎，生歿同日）／
`0866`（2008-07-03 生、翌日歿）。ISB 名字欄全部污染成 `JAZGA`／`JAZG`，RPF 一筆都未收錄。
依〈幼逝寶寶收錄原則〉未命名不建條目，只寫進父母雙方子女表（`| (無名) 🪽 |` 起頭，不長親子邊）。
連帶兩項改判：**`shuuna-2006-07-04` 與 `kuu-2008-07-03` 各自是雙胞胎**（同胎分別為 `0677`／`0866`）。
`miu-2010-07-19`／`sea-2010-07-19` 在資料截止後出生，不在 ISB 內，非缺漏。

**順帶對帳無缺的三處**：`01111`（トクトク）逐欄亦全對，其獨子 `0772`＝`shun-shun-2007-07-01`（母 `0262`）；
`00103`（楢）逐欄全對；父方 `sire == 8856` 的 13 筆與 `chou-chou-1986` 子女表 12 隻＋RPF #783 無名仔完全對得上。
`00103` 的 `NIHONDAIR 18 Dec 2001` 與《ズーしずおか》84 号的「2001.12.18 来園」一致——
即該頁既有「送出日 12/17 vs 抵達日 12/18」之別再得一個獨立佐證，`zoos:` 不動。

**更新條目**：

- `shuu-shuu-2001-07-21.md` — 補 `isb_checked: 2026-08-26`＋ISB `sources`；子女表 4 → 10 隻並改為含性別／備注的四欄式；
  `Sea` 原為純文字 → 補 `sea-2010-07-19` 連結（母頁與本人頁皆已有父母行，不新增親子邊）；
  ½ 手足行「三胞胎」→「四胞胎」＋補 2000-07-15 夭折的兩隻（2026-08-24 那輪漏改的頁）；新增「## 備注」段
- `toku-toku-2001-07-21.md` — 補 `isb_checked: 2026-08-26`＋ISB `sources`；½ 手足行同上修正；新增「## 備注」段
- `nara-2000-07-17.md` — 補 `isb_checked: 2026-08-26`＋ISB `sources`；子女表 5 → 11 隻、加 ISB 番號欄位資訊；
  `Fu-Fu（#? 🪽）` 純文字 → 補 `fu-fu-1997-06-20` 連結（父欄非首格，不長親子邊）；新增「## 備注（ISB）」段
- `shuuna-2006-07-04.md`／`kuu-2008-07-03.md` — 補 `isb_checked: 2026-08-26`＋ISB `sources`；
  家族段加「同胎」行（未建條目，W2b 折抵）；半血緣行的 `Fu-Fu` 純文字補連結；新增「## 備注」段

**驗證**：`tools/verify.sh` 🔴 0 / 🟡 44、check_twins 263 同生群 0 錯誤 0 警告（新同胎皆未建條目，數字不變動符合預期）。
`tools/isb_audit.py --section 4` 中 `01112`／`01111`／`00103`／`0676`／`0865` 皆已不在「子女表漏 ISB 有載的」名單內。
**未重建**：本輪沒動親子邊、居住史與 frontmatter 的資料欄（只加 `isb_checked` 與 `sources`），故未跑 `rebuild.sh`。

## [2026-08-26] update | 誼誼 `8534` 子女 ISB 全掃：6 筆與 wiki 逐筆吻合，另補三頁 `isb_checked`

承同日「父不詳」裁定，維護者要求用 ISB 回看誼誼的子女。掃 `sire == 8534` 得 **6 筆**，與本頁兩張表無缺無多：

| ISB | 性 | 生日 | 母 | 事件 | wiki |
|-----|----|------|----|------|------|
| `8752` | ♂ | 1987-05-31 | `8535` 花花 | NAGANO 出生 → SABAE 1988-11-25 → 歿 2007-12-19 | `yuu-yuu-1987-05-31` |
| `8753` | ♀ | 1987-05-31 | `8535` | NAGANO 出生 → SASEBO 1991-10-30 → 歿 2003-05-13 | `ai-ai-1987-05-31`（2026-08-12 已核） |
| `8754` | ♂ | 1987-06-20 | **`8536` 美美** | NAGANO 出生 → 1987-06-22 歿 | 無條目（幼逝） |
| `8839` | ♂ | 1988-06-17 | `8535` | NAGANO 出生 → 1988-10-18 歿 | 無條目（幼逝；名字欄空白、無 JAZGA） |
| `8840` | ♀ | 1988-06-17 | `8535` | NAGANO 出生 → 歿 2008-01-19（`Old age`）、**無移動紀錄** | `rei-1988-06-17` |
| `8920` | ♂ | 1989-06-30 | `8535` | NAGANO 出生 → HAMAMATSU 1990-03-20 → 歿 1995-09-13 | `genki-1989-06-30` |

性別・生日・父母・亞種・移動日・歿日**逐欄全對**，居住史無中繼園遺漏。**本隻沒有第三位配偶。**
ISB 收錄及於 2008-12-31、本隻 1990-03-19 即歿，故此即一生全部（惟 ISB 對日本 1980 年代繁殖偶有缺漏，非絕對）。

**⭐ 順帶釐清的兩件事**：

1. **1988 年 11 月茶臼山與西山對調了一隻年輕雄性**：`8752`（友友）1988-11-25 移西山、
   `8713`（陽陽 `you-you-1987-07-26`）1988-11-24 由西山移入茶臼山，**前後差一天**。
2. **兩隻種雄在 ISB 上分得很清楚**：1989 年起愛愛 `8753` 所生的 `8925`／`8926`／`9059`
   （太郎／愛子／次郎）記 `sire 8713`，花花 1988–89 的兩胎仍記 `sire 8534`。
   花花 1991 年的 `9167`（マホ）也是 `8713`——與條目原本就寫的父欄一致。

**❌ 順手推翻一處敘述**：`genki-1989-06-30` 引言寫「是花花諸多子女中最短命的一隻」——
把兩隻夭折的無名仔算進去就不成立（`8839` 4 個月、`9687` 3 日）。已改為
「已建條目的 13 名子女中最短命，15 胎中第三短命」。又一次「最高級敘述要回 ISB 掃全批」的老毛病。

**更新條目**：

- `yuu-yuu-1987-05-31.md`／`rei-1988-06-17.md`／`genki-1989-06-30.md` — 各補 `isb_checked: 2026-08-26`、
  `sources` 加 ISB、內文加 ✅ 逐欄對帳段（友友那頁另記 1988-11 的對調、元気那頁另記移園日＝父歿翌日）
- `i-i-1983.md` — 補 `isb_checked: 2026-08-26`；子女表四列補 ISB 番號與移動日；
  對帳註記改寫為「完整性 ✅ ＋ 同期第二隻種雄陽陽」

**重建（同日第二次）**：本輪只動內文與 `isb_checked`，仍重跑 `rebuild.sh` 讓 dev「編號」列的 ✅ 日期生效。
1110 個體／1639 親子邊不變、check_twins 0 錯誤；`redpanda.db` 與 `pipeline/data/*.json` 已寫回本機。
容器重生的居住史表與本機逐檔相同（diff 0）。暫存 tar：`_to_delete/rebuild2-20260826.tgz`。

## [2026-08-27] update | マホ ISB `9167` 逐欄對帳：全對，補 4 名已建條目的 ½ 手足與「懷孕移園」時序

**來源**：
- https://web.archive.org/web/20120128200628/http://www.rotterdamzoo.nl/import/assetmanager/2/6732/Red%20Panda%20Studbook.pdf （ISB 2008 年版 `9167`）

**對帳結果（無不符）**：

```
9167  F  6 Jun 1991  sire 8713  dam 8535  MAHO  JAZGA 147C  styani
      NAGANO   6 Jun 1991  Birth
      MIYAZAK 13 Mar 1993  Transfer
               9 May 1999  Death   [Death by: Unknown means]
```

性別・生歿日・亞種・父（`8713` 陽陽）・母（`8535` 花花）・居住史（茶臼山出生 → 1993-03-13 移宮崎）與名字欄
**逐欄全對**，居住史無中繼園遺漏。`dam == 9167` 反查僅得 `9390`（`hou-hou-1993-06-21`）與 `9391`
（`fumi-1993-06-21`）兩筆，與條目子女表相符、無缺漏。`isb_audit.py --section 2/4` 亦未列本隻。
2026-08-17「轉出園由みさき公園更正為宮崎」的裁定同時複核 ISB 原文，內容無誤。

**⭐ 順帶補上的兩處條目缺漏**（非與 ISB 衝突，是本頁自己沒跟上）：

1. **½ 兄弟姊妹清單漏 4 隻已建條目者**：清單自稱「已建條目者」，但 `dam == 8535` 的 13 隻有條目個體中
   缺 `ai-ai-1987-05-31`（`8753`）、`rei-1988-06-17`（`8840`）、`min-min-1993-06-27`（`9394`）、
   `shun-1995-06-17`（`9593`）。母頁 `hoa-hoa-1982-06-15` 的子女表本來就是完整的，只有本頁沒同步。
   已補齊為 12 隻並加註 2 隻未建條目的夭折仔（`8839`／`9687`）。
2. **未記「懷孕移園」時序**：父勇勇（`9052`）1991-10-17 起終生在茶臼山、從未到宮崎；雙胞胎受孕期
   （約 1993 年 2 月）マホ 仍在茶臼山。此說明在 `yuu-yuu-1990-06-25`／`fumi-1993-06-21`／`hou-hou-1993-06-21`
   三頁都有，唯獨母親頁沒有，容易被誤讀成勇勇也在宮崎。已於子女表前補上。

**更新條目**：

- `maho-1991-06-06.md` — 補 `isb_checked: 2026-08-27`、備注加 ✅ 逐欄對帳段、½ 手足清單補 4 隻、子女表前加受孕時序註記
- `index.md` — 頁首「最後更新」改 2026-08-27（條目總數 1110 不變）

## [2026-08-27] fix | `yuuto-2014-07-22`／`yuuka-2010-06-20` 加入平假名 `ゆうと`／`ゆうか`

**維護者指示**：`yuuto-2014-07-22` 增加別名「ゆうと」；`yuuka-2010-06-20`（RPF #377、優花）增加別名「ゆうか」。依 CLAUDE.md「名稱（尤其中文名、暱稱、別名）以作者提供為準」直接採用，不另記 `sources`。

**更新條目**：

- `yuuto-2014-07-22.md` — `japanese: 優砥, ユウト` → `優砥, ユウト, ゆうと`
- `yuuka-2010-06-20.md` — `japanese: 優花, ユウカ` → `優花, ユウカ, ゆうか`
- 兩者 H1 與 `index.md` 均未動：標題括號慣例只並列漢字與原有主要假名、index 列標籤不因追加假名而擴充（比照 2026-08-24 的 `yuuka-2016-07-14`／`ichiha-2014-08-18`，及 `mitsu-2016-06-22` 的「光, みつ, ミツ」）

**備注**：新假名一律接在既有假名之後、漢字保持第一，本輪為「片假名在前、追加平假名」的反向情形，作法相同。`extract_kanji` 仍取首個漢字 token（優砥／優花），`kanji` 欄不變。

## [2026-08-27] fix | `yuuka-2010-06-20` 歿日由 2016-08-16 更正為 **2016-08-15**（8/16 為園方發表日）

**維護者指示**：優花過世的日子應該是 8/15，並附産経新聞報導。

**來源**：
- https://www.sankei.com/article/20160818-PCPUF2GELVLPZHVVR5XY3SSKXE/ （産経新聞 2016-08-18〈「優花」「さくら」安らかに…レッサーパンダとキリン、愛媛県立とべ動物園の人気者〉；報導とべ動物園於 8/16 發表，記優花「今月15日、歩行困難になり同日夕、敗血症で死んだ」）

**判斷**：原值 2016-08-16 僅以 RPF #377 為據（線索級）。産経報導明寫園方「16日、発表した」而死亡發生在「今月15日…同日夕」，正好解釋 RPF 為何記 8/16——**RPF 抄的是發表日**。故採 2016-08-15，不標 `🚧`。報導同時佐證享年 6 歲、配偶シャンチー、3 頭出産、平成24年3月自徳山來園，皆與既有條目相符。

**查證範圍**（照〈查證省時原則〉各搜一輪即停）：とべ動物園現行官網「死亡報告」分類只回溯到 2025-12；Wayback 對 `tobezoo.com/tobenews/animalinfo/*` 在 2016 年無任何快照（該路徑 2016 年尚不存在）；2016 年站上與動物有關的 `animal_hp/status/` 為野生動物「保護状況」PDF、非訃報。ISB 為 2008 年版，2010 年出生者不在範圍。三層皆無官方一手，故以新聞報導為據並記入 `extra_sources`。

**更新條目**：

- `yuuka-2010-06-20.md` — `died: 2016-08-16` → `2016-08-15`；`zoos:` とべ 訖日同步改 2016-08-15（居住史表由 `gen_residence.py` 重生）；引言歿日改 8 月 15 日；內文補歿因「敗血症」與病程（5 月中旬右後腳外傷感染腫脹 → 7 月底擴及左前腳 → 8/15 行走困難、當日傍晚辭世）；新增 ℹ️ 註記說明 8/16 為發表日；新增 `extra_sources` 一行（新聞報導照 SCHEMA 分工不進 `sources`）
- `index.md` 未動：該兩列僅記年份區間「2010–2016」，不含月日

## [2026-08-27] fix | `ryuunosuke-1999-07-27` 加入別名 `緑乃介`（順帶修正 index 生卒年）

**維護者指示**：`ryuunosuke-1999-07-27` 增加別名「緑乃介」。依 CLAUDE.md「名稱（尤其中文名、暱稱、別名）以作者提供為準」直接採用，不另記 `sources`。

**旁證**（非採用依據，僅記錄）：`sources/ressa-kakei/candidate_missing.csv` 第 33 列以「とべ緑乃介(故)」記本個體（生 1999-07-27／歿 2019-03-12／老衰），與新別名寫法一致。該試算表為第三方非權威來源。

**更新條目**：

- `ryuunosuke-1999-07-27.md` — `japanese: 緑之介` → `緑之介, 緑乃介`
- H1（`# Ryuunosuke 🪽`）與各親屬條目內文的「（緑之介）」標註均未動：比照 2026-08-27 `yuuto`／`yuuka` 追加別名的作法，別名只進 frontmatter，不擴充標題與交叉引用的括號標籤。`extract_kanji` 仍取首個漢字 token（緑之介），`kanji` 欄不變
- `index.md` — **順帶修正**：`ryuunosuke` 該列生卒年由 `1999–2018` 改為 `1999–2019`。2026-07-01 作者裁定曾採多摩名單的 2018-03-12 並同步 index，其後依愛媛県立とべ動物園官方死亡報告改回 **2019-03-12**（見本日誌「歿日由 2018-03-12 改為 2019-03-12」一則）時 index 未跟上，屬殘留舊值；frontmatter `died` 與內文 📝 註記本來就已是 2019-03-12，本次僅補齊 index

## [2026-08-27] update | 緑之介 ISB `9998` 逐欄對帳：⭐ とべ 轉入日補為 2001-04-08；⚠️ 判 ISB 把緑太郎歿年誤植成 2009

**來源**：
- https://web.archive.org/web/20120128200628/http://www.rotterdamzoo.nl/import/assetmanager/2/6732/Red%20Panda%20Studbook.pdf （ISB 2008 年版 `9998`／`9997`）
- https://www.tokyo-zoo.net/topics/news/tama/7619_8350_2008-02-08.html （東京動物園協會 2008-02-08：緑太郎 死亡公告）

**對帳結果**：

```
9998  M  27 Jul 1999  sire 9049  dam 93107  RYUNOSUKE  2752 / JAZGA 415C  styani
      TOKYOTAMA 27 Jul 1999  Birth
      TOBE       8 Apr 2001  Transfer
```

性別・生日・父（`9049` 緑々）・母（`93107` 寧々）・出生園・名字欄・亞種**逐欄全對**。無死亡列屬正常（該版資料截止
2008-12-31，本隻 2019 年才歿）。子女以 `sire == 9998` 反查得 7 筆（`0269`／`0464`／`0465`／`0574`／`0780`／`0878`／`0879`），
母全為 `9992` 伶伶，與條目子女敘述完全相符、無缺漏。

**⭐ ISB 補到的新資料**：とべ 的轉入日 **2001-04-08**（`TOBE 8 Apr 2001`）——條目原僅記年份「2001」。
多摩段起日同步補為生日 1999-07-27。

**⚠️ 一處 ISB 錯、wiki 對**：ISB `9997`（雙胞胎 `ryutarou-1999-07-27`）記歿日 `4 Feb 2009`，
但東京動物園協會 2008-02-08 公告明載「2008年2月4日…8歳6か月」（死因：てんかん発作による誤嚥性肺炎，
癲癇自 2006 年 12 月底起治療）。2026-07-01 已依此由 2009-02-04 更正為 2008-02-04，**本次維持 2008-02-04、判 ISB 年份誤植**。
ISB 2008 年版於 2009-10-01 印出、確實含少量 2009 年事件（全簿約 38 筆），故該日期本身不離譜，但與園方公告牴觸。
順帶補記：該公告連結原本沒進 `ryutarou` 的 `sources`（只列 RPF #306），本次補上。

**⭐ 順帶補上的兄姊／½ 弟妹清單**（與 `maho-1991-06-06` 同型缺漏：母頁 `nene-1993-07-11` 的 17 隻子女表 2026-08-14
已對帳補齊，但兩隻子頁沒跟上）：兩頁原本只列「三胞胎＋淡々」四隻，現補上同父同母的 `ki-ki-1996-06-27`（希々）與
`ran-ran-1998-06-29`（蘭々，淡々雙胞胎，1999-07-20 歿），並新增 ½ 弟妹行（母方寧々、父ブーブー）6 隻
（`nana`／`hana`／`nono`／`nami`／`non`／`noa`），另以註記交代 3 隻未建條目的夭折／死産者（`95110`／`00108`／`0374`，
其中 `00108` 之父為己出之子風風，是母子近親一例）。

**更新條目**：

- `ryuunosuke-1999-07-27.md` — `zoos:` 補完整日期（多摩 1999-07-27 – 2001-04-08／とべ 2001-04-08 – 2019-03-12）；
  補 `isb_checked: 2026-08-27` 與 ISB `sources`；引言補「4 月 8 日」；兄姊／½ 弟妹清單補齊；新增 `## 備注`（三段對帳記錄）
- `ryutarou-1999-07-27.md` — 補 `isb_checked: 2026-08-27`、`sources` 加園方死亡公告與 ISB；兄姊／½ 弟妹清單同步補齊；
  新增 `## 備注`（歿日不採 ISB 的理由＋其餘欄位逐欄對帳）

## [2026-08-27] add | `shun-shun-1987-06-15`（菊シュンシュン／ISB `8931`）＋ 更正 `yan-yan-1990-07-14` 的漢字與子女

維護者提供一筆手邊資料（`菊シュンシュン`／♀／1987-06-15 生於中國／轉入 愛媛県立とべ動物園／親 wild／2000-08-08 歿於 千葉市動物公園）要求與 ISB 對照。對到 ISB `8931`：歿日 `8 Aug 2000` 在 ISB-2008 全簿唯一，配合 ♀・`WILD`×`WILD`・`CHINA` 捕獲・`TOBE 20 May 1989` 四項相符，身分認定無虞。

同輪由 `dam == 8931` 反掃挖出 `9589`（♂，1995-05-30 生於 TOBE、當日夭折，`sire 9062`），推翻 `yan-yan-1990-07-14` 原記的「子女：無（ISB 亦無以 `9062` 為 `sire` 的紀錄）」——該句為前次建檔漏查，`data/isb-overrides.json` 無相關覆寫。`9589` 終生未命名，依慣例不建條目。

**來源**：
- 國際血統登録書 2008 年版（`sources/isb-red-panda/ISB-2008.txt`）`8931`／`9589`／`9062`
- 維護者提供（2026-08-27：名字「菊シュンシュン」、生日 1987-06-15、歿於千葉市動物公園；`yan-yan-1990-07-14` 的漢字名「陽陽」）

**新增條目**：
- `shun-shun-1987-06-15.md` — Shun-Shun 菊／シュンシュン（ISB `8931`，`JAZGA 097C`，RPF 未收錄），♀，1987-06-15 生於中國（野生捕獲），1989-05-20 入 愛媛県立とべ動物園，後移 千葉市動物公園，2000-08-08 歿（享年 13 歲）

**更新條目**：
- `yan-yan-1990-07-14.md` — `japanese` 補漢字「陽陽」（維護者提供）；標題與同名提示同步；「未留下子女」更正為與 `8931` 育有一仔 `9589`（當日夭折）；備注加更正說明
- `yan-yan-1988-06-18.md` — 同名提示中的 `yan-yan-1990-07-14` 補漢字
- `index.md` — 新增〈1989 年中國輸日群〉一節與 `shun-shun-1987-06-15`；更新 `yan-yan-1990-07-14` 該列；條目總數更新為 1111

**待查證**：
- 歿地「千葉市動物公園」無線上官方佐證：ISB `8931` 末站只記 `TOBE`、無移往 `CHIBA SHI` 的紀錄（惟同批的 `8929`＝`tom-1987` 也有整段とべ 未被 ISB 收錄的前例）。2026-08-27 已查兩園官網、千葉市動物公園年報（官網僅存令和元年度以後）與 Wayback（tobezoo.com 最早 2003 年、city.chiba.jp/zoo 最早 2001 年且無個體層級資料），皆無所獲。とべ→千葉 的移園日不詳，`zoos:` 兩站的訖／起留空
- 漢字「菊」讀音（キク／jú）與假名 `シュンシュン` 對不上，維護者裁定暫視為「名字被寫成漢字」收入 `japanese`；生日 1987-06-15 亦僅維護者提供、ISB 只記 `~ 1987`

## [2026-08-27] fix | `rin-rin-1999-07-09` 漢字定案「伶伶」（舊值怜怜降為異寫）＋補假名リンリン；🚧 漢字歧異結案

**維護者指示**：`rin-rin-1999-07-09` 加上名字「伶伶、リンリン」，並確認 **伶伶 為正式用字（漢字第一＝上站顯示的字）、
舊值 怜怜 保留為異寫**。依 CLAUDE.md「名稱（尤其中文名、暱稱、別名）以維護者提供為準」直接採用，不另記 `sources`。

**結案的待查項**：2026-08-15 建 `yuu-yuu-1991-06-20`（母友友）時留下的
🚧「同好資料記 ISB `9992` 為『伶伶』、wiki 現行『怜怜』，讀音同為リンリン，正式用字待查」。
本次定案為 **伶伶**。⚠️ 這同時解掉一組長期混淆——漢字確為「怜怜」的是 `rin-rin-1992-06-21`
（RPF #659，ひらかたパーク，`mai-1995-07-09` 之母），兩隻原本同漢字同拼音；**該隻此次未動**。

**更新條目**：

- `rin-rin-1999-07-09.md` — `japanese: 怜怜` → `伶伶, 怜怜, リンリン`；H1 由
  `# Rin-Rin 🪽（Ron-Ron 之母）` 改為 `# Rin-Rin 🪽（伶伶 / リンリン）`（原括號內是敘述而非名字，
  引言區塊已載「Ron-Ron 之母」）；備注新增裁定紀錄
- 交叉引用「怜怜」→「伶伶」共 10 檔 15 處：`ai-ai-2008-07-31`／`aporo-2004-06-28`／`kei-kei-2008-07-31`／
  `kiki-2007-07-25`／`ten-ten-2005-07-12`（引言＋母行各一）、`fan-fan-1999-07-09`（雙胞胎行＋ISB 對帳段）、
  `yuu-yuu-1991-06-20`（引言／子女表／三處敘述）、`an-an-1984`／`san-san-1984`（「花花・怜怜之母」）
- `yuu-yuu-1991-06-20.md` — ⚠️ 漢字歧異註記改寫為 ✅ 已結案
- `rin-rin-1993-06-29.md`／`rin-rin-1993-07-17.md` — 兩處同名消歧塊為本隻補上漢字「伶伶」
  （原本只寫「#34，東北」，且「東北」實為誤述——本隻居池田→とべ，已一併改正）
- `index.md` — 本隻列標籤補「伶伶」；友友那列的「怜怜」改「伶伶」；`rin-rin-1992-06-21` 列的消歧註記
  補記「後者已改記伶伶」
- `log.md` — 順手更正本日「緑之介 ISB `9998` 對帳」一則裡把 `9992` 誤寫成「鈴々」的字（應為伶伶）

**未動**：`rin-rin-1992-06-21`（漢字怜怜的那隻）與其他 12 隻同拼音個體；`sources`（名稱由維護者提供，照慣例不加來源行）。

## [2026-08-27] fix | `ten-ten-2005-07-12` 加入片假名 `テンテン`

**維護者指示**：`ten-ten-2005-07-12` 增加名字「テンテン」。純追加假名，照〈追加別名〉慣例接在漢字之後、
不另記 `sources`（名稱以維護者提供為準）。與同拼音的 `ten-ten-1992-06-26`／`ten-ten-1997-07-03`／
`ten-ten-1998-07-07` 三隻寫法一致（皆 `天天, テンテン`）。

**更新條目**：

- `ten-ten-2005-07-12.md` — `japanese: 天天` → `天天, テンテン`
- H1（`# Ten-Ten 🪽（天天）`）與 `index.md` 列標籤（`Ten-Ten 天天`）**未動**：照慣例追加假名不擴充標題與 index；
  `extract_kanji` 仍取首個 token，`kanji: 天天` 不變

## [2026-08-27] fix | `kiki-2007-07-25` 加入片假名 `キキ`

**維護者指示**：`kiki-2007-07-25` 增加名字「キキ」。純追加假名，照〈追加別名〉慣例接在漢字之後、
不另記 `sources`（名稱以維護者提供為準）。同拼音的 `kiki-1992-07-20` 亦作 `貴貴, キキ`，寫法一致。

**更新條目**：

- `kiki-2007-07-25.md` — `japanese: 喜喜` → `喜喜, キキ`
- H1（`# Kiki（喜喜）`）與 `index.md` 列標籤（`Kiki 喜喜`）**未動**：照慣例追加假名不擴充標題與 index；
  `extract_kanji` 仍取首個 token，`kanji: 喜喜` 不變

**同批已完成、無需再動**：`ten-ten-2005-07-12` 的 `テンテン` 已於本日前一則紀錄加入（現為 `天天, テンテン`）。


## [2026-08-27] verify | `ron-ron-1994-06-24` ISB `9449` 逐欄覆核（手足行補兩筆）

**維護者指示**：核對 `ron-ron-1994-06-24`（アドベンチャーワールド，RPF #724）的 ISB。

**本隻逐欄全對**：`M`／`~ Jun 1994`／sire `8929`（トム）／dam `9169`（チィチィ）／名字欄 `RON-RON`／
局番 `JAZGA 254C`／`styani`／事件 `TOKUYAMA ~ Jun 1994 Birth ｜ SHIRAHAMA ~ 1995 Transfer`。
生日只到月，粒度低於條目的 1994-06-24，**維持不改採**（2026-08-09 舊裁定）；
`SHIRAHAMA ~ 1995` 是「1995-07-12 移居アドベンチャーワールド」的獨立佐證（此前只有 RPF）。
無 Death 列屬正常——2011-09-06 歿於收錄截止（2008-12-31）之後。

**子女無缺**：`sire == 9449` 得 5 筆、母全是 `9492`（リン），與子女表逐筆吻合，無其他胎次、無未命名夭折仔。
（`98034` 的 ISB 名字欄記 `HUU-HUU`，wiki 用フウ／Fuu，僅註明不改資料。）

**更新條目**：

- `ron-ron-1994-06-24.md`
  - 新增「全血緣兄弟姊妹（同父母）」行：(無名) ♀ 1993-07-01 徳山生・當日夭折，ISB `93104`
  - ½ 手足行補 (無名) ♀ 1998-07-17（母美美，ISB `98037`，トム 之末胎），並為每位 ½ 手足補記母親
  - 清掉 ½ 手足行三處 **stale 🚧**（龍龍／優優／健健 的父為トム，已於 2026-08-20 由 ISB
    `9590`／`95106`／`95107` 佐證，見 `tom-1987`）
  - 補 `isb_checked: 2026-08-27` ＋ ISB Wayback `sources`
  - 備注末補 ✅ ISB `9449` 逐欄對帳 block

⚠️ 兩筆夭折仔早在 `tom-1987`（父）與 `chi-chi-1991-06-16`（母）兩頁載明（2026-08-20），
**只有本隻自己的頁沒跟上**——同 `maho-9167` 那次的模式。核某隻的 ISB 時，父母頁若已 `isb_checked`，
要回頭比對「父母頁子女表 ⊖ 本頁手足行」。

**驗證**：`bash tools/verify.sh` → 🔴 0、check_twins 0 錯誤 0 警告；
`python3 tools/isb_audit.py --section 4` 已無 `9449`。**未跑 `rebuild.sh`**：兩筆夭折仔皆未建條目，
沒動親子邊、居住史與資料欄。

---

## [2026-08-27] verify | 景景 `0878`／愛愛 `0879` ISB 逐欄覆核：全對，無死亡列不等於歿日線索

維護者要求核對 `ryuunosuke-1999-07-27`（緑之介，ISB `9998`）兩名子女的 ISB 資訊，
接續同日的 `9998` 對帳。兩筆逐欄全對、**無任何需更正的值**：

```
0878  M  31 Jul 2008  sire 9998  dam 9992  TOBE 31 Jul 2008 ______ Birth  KEI-KEI  JAZGA 666C  styani
0879  F  31 Jul 2008  sire 9998  dam 9992  TOBE 31 Jul 2008 ______ Birth  AI-AI    JAZG  667C  styani
```

- **事件列都只有 `Birth` 一行**（無 Death、無 Transfer），與條目原本的敘述一致。
  ⚠️ 但兩隻在全簿依出生日排序是**倒數第三／倒數第二筆**（其後只剩 `0884`），
  距資料截止日 2008-12-31 僅約 5 個月 → **「該版無死亡列」只能推出「至少活過 2008 年底」**，
  對歿日毫無縮限力，兩頁 🚧 維持不動。
- **同胎確認就是這兩隻**：掃全簿 `TOBE` 出生列，2008-07-31 僅此二筆，局番連號 `666C`／`667C`。
- **全血緣手足無缺**：`sire == 9998` 與 `dam == 9992` 反查得**同一組 7 筆**，
  即父母雙方在收錄範圍內都無其他配偶、無夭折未建條目者；兩頁手足行逐筆吻合。

**⚠️ `0879` 的局番 ISB 原檔印作 `JAZG 667C`（少一個 A）**——`ISB-2008.pdf` 不加 `-layout`
重抽亦為 `JAZG`，**不是 `pdftotext` 造成的**。判為原檔缺字、wiki 仍記 `JAZGA 667C`：
`JAZG` 非既有代碼、與同胎 `666C` 連號，且全簿另有 **42 筆**同型缺字（如 `0664` `JAZG 597C`）。
→ **`ISB-2008.txt` 的欄位值不能逐字當權威**，同 `chi-chi-1991-06-16` 記過的名字欄污染。

**更新條目**（僅補對帳痕跡，資料欄未動）：`kei-kei-2008-07-31.md`、`ai-ai-2008-07-31.md`
各補 `isb_checked: 2026-08-27` ＋ 新增 `## 備注` 對帳 block。ISB Wayback `sources` 兩頁本已有。

**⚠️ 待辦（本輪未動）**：`isb_audit.py --section 4` 對 `9998` 與 `9992` 各報「ISB 記 7 隻，缺 7」，
實際不是缺漏——七名子女都寫在兩頁的**引言段落**、`## 家族` 沒有「子女」行，工具抓不到。
要消掉這兩筆噪音得在 `ryuunosuke-1999-07-27` 與 `rin-rin-1999-07-09` 補正式子女行，待維護者決定。

**驗證**：`bash tools/verify.sh` 通過；未跑 `rebuild.sh`（未動 `zoos:`／親子邊／資料欄）。

**追補（同日）**：維護者問「這兩筆沒有子女嗎」。掃全簿 `sire`／`dam` 欄以 `0878`／`0879` 為親者
**各 0 筆**，但這是**結構性的 0、不構成「未留下後代」的佐證**——兩隻在資料截止日 2008-12-31
**才 5 個月大**，未達性成熟（約 18 個月），ISB 不可能登録到子女。同「無死亡列」之理。
wiki 端亦無任何條目以牠們為父／母（`mother_ref`／`father_ref` 反查 0 筆）。
兩頁備注各補一條寫明此界限，並指出真要查得循 RPF #716／#715 的 children 欄與とべ官方出生公告。

---

## [2026-08-27] update | 景景／愛愛 漢字由とべ官方飼育日記定案，在世下限推進至 2009-04-30

維護者提供愛媛県立とべ動物園〈キーパー飼育日記〉2009-04-30〈愛愛と景景〉：
https://www.tobezoo.com/shiiku_diary/keeper/article/200904-000788.html
（`tobezoo.com` 已在 `OFFICIAL_HOSTS`，屬官方一手，依「官方來源可直接採用」逕行更新。）

原文：「昨年の7月31日に生まれた双子の赤ちゃん（愛愛と景景）は順調に成育し大きくなりました。
お母さん似の愛愛は甘えん坊で、リンゴやキウイが大好きです。一方、お父さん似の景景は
好奇心が旺盛で笹を真っ先に良く食べます。」

**更新條目**：

- `kei-kei-2008-07-31.md` — 補 `japanese: 景景`；標題改 `# Kei-Kei 🪽（景景）`；官方連結置於 `sources` 首位
- `ai-ai-2008-07-31.md` — 補 `japanese: 愛愛`；標題改 `# Ai-Ai 🪽（愛愛）`；官方連結置於 `sources` 首位
- 兩頁引言補「最後確認在世：2009-04-30（園方飼育日記）」；🚧 區塊改寫
- `index.md` — 說明欄補漢字（條目總數不變）
- 兩頁另補 `last_seen: 2009-04-30`（機器可讀；該欄不進網站渲染，`web/src` 無任何引用，
  另有 6 筆非 `limited-profile` 條目已循此用法）

**⭐ 在世下限由 ISB 的 2008-12-31 推進到 2009-04-30**，是收錄範圍外的第一筆官方確認
（該文寫兩隻與母親三頭同室、順調成育）。歿日仍不詳，🚧 維持。

**⚠️ 讀音未定、`japanese` 只填漢字**：該文**沒有**任何振り仮名或括號注音
（內文、標題、圖說皆逐項查過）。ISB／RPF 的羅馬拼音 `KEI-KEI`／`AI-AI` 與音読み相容，
但命名依〈資料來源原則〉以維護者為準，片假名待裁定後再補。
⚠️ 同名三隻的漢字各異——本隻是 **景景**，另有 `kei-kei-1982` 慶慶（ISB `8528`）、
`kei-kei-1990` 佳佳（ISB `9284`）；同名註記已改寫點明。

**⚠️ 自我更正**：同日稍早那筆 `verify` 記錄的標題原誤寫成「圭圭」——該漢字是我未經來源的推測
（由其他 Kei-Kei 條目的漢字聯想而來），並非任何來源所載，已就地改為「景景」。

**驗證**：`bash rebuild.sh` 的 `build_db` 在 mount 上仍需 mktemp shim（`redpanda.db` 與 `/tmp/redpanda.db` 都 unlink 不掉），改用 `importlib` 載入後覆寫 `DB_PATH`／`DB_FALLBACK` 至新暫存檔再 `cp` 回 repo；`export_json` 續跑正常。
1111 個體／1639 親子邊／263 同生群，`bash tools/verify.sh` 通過（🔴 0、0 錯誤 0 警告）。

---

## [2026-08-27] update | 景景／愛愛 補歿日（維護者提供）：兩隻都未及性成熟，「無子女」正式結案

維護者提供兩隻的歿日，`sources` 各記一行 `維護者提供（2026-08-27：歿日）`。

**更新條目**：

- `kei-kei-2008-07-31.md` — `died: 2009-05-14`（得年 **9 個月**，未滿一歲）
- `ai-ai-2008-07-31.md` — `died: 2010-02-10`（得年 **1 歲 6 個月**）
- 兩頁：`zoos:` 訖日改為死亡日、移除 `last_seen`、刪去 🚧「歿日與去向待查證」區塊、
  引言改寫為歿日＋得年＋「終生未離園」、備注新增歿日 block
- `index.md` — 生卒欄由 `2008-07-31–? 🪽` 改為實際歿日，說明欄的「歿日待查證」改為得年（總數不變）

**⭐ 景景的歿日距園方 2009-04-30 的飼育日記只有兩週**——那篇「順調に成育し大きくなりました」
成了牠最後一次公開露面。愛愛比雙胞胎兄多活約 9 個月。

**⭐ 同時印證了 ISB 兩個空欄的讀法**：兩隻都歿於 2008-12-31 之後 → 「無 Death 列＝至少活過該日」正確；
得年皆未及性成熟（約 18 個月）→ 「掃不到子女」確實等於沒有子女，
但**那是由歿日推出的、不是由 ISB 的 0 筆推出的**，兩頁備注已寫明這個先後關係。

**收錄原則**：景景未滿一歲夭折，但**有正式命名**，依〈幼逝寶寶收錄原則〉照常收錄上站，不移入 `_hidden/`。

---

## [2026-08-27] fix | 景景 ケイケイ／愛愛 アイアイ 讀音由維護者定案，`japanese` 補假名

承同日兩筆記錄：漢字出自とべ官方飼育日記、但該文無振り仮名，`japanese` 一度只填漢字。
維護者提供讀音後補齊：

- `kei-kei-2008-07-31.md` — `japanese: 景景, ケイケイ`；標題改 `# Kei-Kei 🪽（景景 / ケイケイ）`
- `ai-ai-2008-07-31.md` — `japanese: 愛愛, アイアイ`；標題改 `# Ai-Ai 🪽（愛愛 / アイアイ）`
- `index.md` — 說明欄補假名（總數不變）

**`name:` 與 slug 都不動**：ケイケイ／アイアイ 與 ISB／RPF 的 `KEI-KEI`／`AI-AI` 一致
（「景」的音読みケイ），無需走 `tools/rename.py`。

**⚠️ 記一次幻覺**：查漢字那輪，WebFetch 的**摘要模式**回給我
「愛愛（アイアイ）／景景（**ジンジン**）」。改要求逐字輸出後，原文**一個假名都沒有**；
再反問「有無振り仮名／ruby／alt／title」也答沒有。維護者本次提供的讀音證實
...
## [2026-08-31] rename | `apple-seed-1-lian-2026-06-19` → `marron-2026-06-19`（園方公布正式名（마롱／Marron），蘋果籽轉正）

（本記錄由 tools/rename.py 產生，僅機械變更；脈絡與原因請視需要補充。）

**改名**：

- `apple-seed-1-lian-2026-06-19.md` → **`marron-2026-06-19.md`**（name: → Marron）

**更新條目**（wikilink／siblings 同步更換；其餘資料未動）：

- `apple-seed-2-lian-2026-06-19.md` — wikilink ×2
- `lian-2020-07-20.md` — wikilink ×2
- `ravi-2022-06-11.md` — wikilink ×2
- `index.md` — wikilink ×1；「最後更新」改 2026-08-31；條目總數不變

**備注**：舊網址 /p/apple-seed-1-lian-2026-06-19/ 將失效。


## [2026-08-31] rename | `apple-seed-2-lian-2026-06-19` → `maru-2026-06-19`（園方公布正式名（마루／Maru），蘋果籽轉正）

（本記錄由 tools/rename.py 產生，僅機械變更；脈絡與原因請視需要補充。）

**改名**：

- `apple-seed-2-lian-2026-06-19.md` → **`maru-2026-06-19.md`**（name: → Maru）

**更新條目**（wikilink／siblings 同步更換；其餘資料未動）：

- `lian-2020-07-20.md` — wikilink ×2
- `marron-2026-06-19.md` — wikilink ×2
- `ravi-2022-06-11.md` — wikilink ×2
- `index.md` — wikilink ×1；「最後更新」改 2026-08-31；條目總數不變

**備注**：舊網址 /p/apple-seed-2-lian-2026-06-19/ 將失效。

## [2026-08-31] update | 蘋果籽轉正補述：Lian × Ravi 2026 雙胞胎定名 `Marron`（마롱 ♀）・`Maru`（마루 ♂），性別同日公布

**來源**：

- https://www.instagram.com/seoulgrandpark/p/DcsEkzOjZ6J/ （서울대공원 官方 Instagram，2026-08-31：「[EVENT] 레서판다 쌍둥이 '이름 결정전' 당첨자 발표 🎉」；名字逐字為「• 첫째(암컷) │ 마롱(Marron) 밤처럼 알차고 풍성하게~ 세상을 따뜻하게 품어주길!」「• 둘째(수컷) │ 마루(Maru) 으뜸가는 존재로 많은 이들에게 위로와 사랑을 전하길!」；票選期間 2026-08-19～08-26，「무려 5,000명에 달하는 단짝분들이 함께해 주셨는데요. 59.5%의 선택을 받은 쌍둥이의 이름을 공개합니다!(*총 4,905표 중 2,920표 득표 / 중복 투표 181표 제외)」；貼文首圖為兩隻幼獸合照，已一併寫入 `instagram:`）

**改名**（`tools/rename.py`，機械記錄見上兩筆）：

- `apple-seed-1-lian-2026-06-19.md` → **`marron-2026-06-19.md`**（`name:` Apple Seed 1 → Marron）
- `apple-seed-2-lian-2026-06-19.md` → **`maru-2026-06-19.md`**（`name:` Apple Seed 2 → Maru）

**序號對應**：原 1／2 號是**暫編**（建檔時園方未公布順序，見兩隻原條目末句），本次依園方的 첫째／둘째 直接對應：1 號 → 첫째 → Marron ♀、2 號 → 둘째 → Maru ♂。園方未提供可辨識個體的其他線索，此對應即以園方公布的長幼序為準。

依轉正流程改寫兩隻：移除 `chinese: 蘋果籽N號` 與 `apple-seed` tag、去掉佔位提示區塊；補 `korean: 마롱`／`마루`、`sex: female`／`male` 與對應性別 tag（**性別此前未公布，本次同一則公告首度載明**）；標題改 `# Marron（마롱）`／`# Maru（마루）`，引言補命名票選經過與園方寄語，並在末段留一句說明原佔位 slug 與序號對應。`instagram:` 與 `sources` 各補該則官方貼文。

**名字**：「마롱」園方自附羅馬拼寫 Marron（法語的栗子，寄語即扣「밤（栗子）」）；「마루」為固有詞，有「頂端、最高處」之意，寄語的「으뜸가는 존재」相呼應。**兩者皆採園方公布的拼寫**，未另行轉寫。

**更新條目**：

- `lian-2020-07-20.md`・`ravi-2022-06-11.md` — 子女行由「（2026，未命名）」改為正式名＋韓文名＋性別；內文「（未命名，蘋果籽佔位）」改為兩隻的名字與性別，並補一句名字由園方線上票選、2026-08-31 公布；`sources` 各補該則官方貼文
- `index.md` — 兩列說明欄改正式名、性別欄由「？」改 ♀／♂；Ravi 一節敘述補兩隻的名字；「最後更新」改 2026-08-31；條目總數不變（1149）

**備注**：舊網址 /p/apple-seed-1-lian-2026-06-19/ 與 /p/apple-seed-2-lian-2026-06-19/ 將失效（站無 redirect）。
這兩隻轉正後，`grep -l "apple-seed" wiki/*.md` 的季末盤點名單少兩隻。

## [2026-08-31] update | 春春 `chun-chun-1992-06-22` ISB `9258` 逐欄對帳＋補列子女 8 筆

**起因**：維護者問「春春驗過 ISB 了嗎？為什麼沒亮綠燈」。查得本隻 `studbook_id: "9258"` 早有、但無 `isb_checked`
（旗標語意見 SCHEMA.md 與 dev 編號列）——周邊全對過（父 `8752` 2026-08-26、雙胞胎 `9259` 2026-08-19、
配偶 `9174` 頁 2026-08-15 的子女全表），唯獨沒人以 `9258` 為主體跑過一輪，屬「順帶被補、本體未驗」。

**對帳結果（全對，無矛盾）**：`9258` M・`22 Jun 1992`・sire `8752`／dam `8714`・`styani`・
`SABAE` Birth（`JAZGA 184C`）・`OKAYAMA` Transfer `22 Feb 1994` — 性別／生日／出生園／父母／搬園日逐欄吻合。
全血緣手足掃 `sire 8752`＋`dam 8714` 得 6 筆（`8915`／`9056`／`9171`／`9172`／`9258`／`9259`），與條目所列一致。
ISB 名字欄空白（名字仍僅有 RPF／「西山まとめ」來源）。**無死亡列＝觀察窗外**（該版收錄至 2008-12-31、本隻 2010-02-18 歿），非矛盾。

**唯一的缺漏＝子女**：條目末句停在「於 lineage 另記有數名子女（待補）」，但 `sire 9258` 掃全表的 8 筆
（`95115`／`95116`／`9990`／`9991`／`9992`／`0285`／`0376`／`0377`，dam 皆 `9174`）早在配偶
[[yuu-yuu-1991-06-20]] 頁列全，且 `fan-fan-1999-07-09`／`rin-rin-1999-07-09` 兩隻條目已反指本隻為父。
典型「配偶頁補了、本頁沒跟上」（同 `maho-9167` 那次的模式）。

**更新條目**：

- `chun-chun-1992-06-22.md` — 補 `isb_checked: 2026-08-31`；`sources` 補 ISB 血統登録書（Wayback，自動歸 dev-only）；
  家族段補「配偶」行與「子女」表 8 筆（比照配偶頁）；引言補一句配偶與 8 仔；末尾 stale 的
  ℹ️「數名子女（待補）」改為 ✅ 對帳 ×2 ＋ ℹ️ 觀察窗說明

**未動（待裁定）**：母 [[ran-ran-1987-07-26]]（`8714`）與配偶 [[yuu-yuu-1991-06-20]]（`9174`）同樣有番號、無
`isb_checked`；後者備注裡的「身分認定（2026-08-15）」其實已是逐欄對帳等級（本次順手覆核 `9174` 亦全對：
♀・`20 Jun 1991`・sire `8643`／dam `8644`・`OKAYAMA` 出生且終生未離園・歿 `11 Dec 2004`），
惟回填當初刻意只採內文寫「✅ … 對帳」者，故不自行補旗標。

## [2026-08-31] update | 蘭蘭 `8714`・池田友友 `9174` 逐欄對帳並補 `isb_checked`；西山慶慶×秀秀 四手足互指補齊

承上一筆（春春 `9258`）維護者指示「請補」。兩隻皆逐欄對過、全對，非批次填旗標。

**蘭蘭 `ran-ran-1987-07-26`（ISB `8714`）**：♀・`26 Jul 1987`・sire `8528`（慶慶）／dam `8427`（秀秀）・
`SABAE` Birth（`JAZGA 060C`）・`styani`・**全簿無 Transfer**（與「一生皆在西山」吻合）・無死亡列＝觀察窗外
（該版收錄至 2008-12-31、本隻 2009-06-03 歿）。⭐ **ISB 名字欄記 `RAN-RAN`**——該版日本個體此欄多為空白，
故「蘭蘭 ランラン」之名有官方登録書佐證，非僅社群資料。子女以 `dam 8714` 掃全表得 6 筆
（`8915`／`9056`／`9171`／`9172`／`9258`／`9259`），與條目子女表一一對應、sire 皆 `8752`。

**池田友友 `yuu-yuu-1991-06-20`（ISB `9174`）**：♀・`20 Jun 1991`・sire `8643`（山山）／dam `8644`（安安）・
`OKAYAMA` Birth（`JAZGA 156C`）・`styani`・歿 `11 Dec 2004`・**全簿無 Transfer**（終生未離開池田）。
手足 `sire 8643`＋`dam 8644` 得 6 筆、子女 `dam 9174` 得 8 筆，皆與頁上兩表一致。
該頁 2026-08-15 的「身分認定」其實早已達逐欄對帳標準，只是措辭不是「✅ … 對帳」，當初回填旗標時漏掉。

**⭐ 順帶補齊：慶慶 `8528` × 秀秀 `8427` 的四名子女互指不完整**。掃 `sire 8528`＋`dam 8427` 得 4 筆
（`8628` 麗麗／`8690` 誕誕／`8713` 陽陽／`8714` 蘭蘭，恰為兩對雙胞胎），但只有誕誕頁列全四隻；
蘭蘭與陽陽兩頁都漏了麗麗、麗麗頁漏了蘭蘭與陽陽。已三頁補齊（同「本頁沒跟上」的老模式）。

**更新條目**：

- `ran-ran-1987-07-26.md` — 補 `isb_checked: 2026-08-31`；`sources` 補 ISB 血統登録書（Wayback→dev-only）；
  「兄」行改「兄姊」並補 `lili-1986-07-05`；新增 `## 備注`（✅ 對帳 ×2 ＋ ⭐ 手足補列 ＋ 觀察窗 ＋ 雙親生年說明）
- `yuu-yuu-1991-06-20.md` — 補 `isb_checked: 2026-08-31`；備注首項新增逐欄對帳記錄
- `you-you-1987-07-26.md` — 「兄」行改「兄姊」並補 `lili-1986-07-05`
- `lili-1986-07-05.md` — 新增「手足」行（`ran-ran-1987-07-26`／`you-you-1987-07-26`）

**查得但未動**：

- **雙親生年 ISB 也解不了**：`8528`（慶慶）記 `~ 1983`（推定）、事件是 `SABAE 2 Apr 1985 Transfer` 非出生；
  `8427`（秀秀）生日欄逕記 `????`、`CHINA … Capture` 後 `SABAE 2 Apr 1986 Transfer`、`27 Feb 1988` 歿
  （歿日與 wiki 一致）。故 `kei-kei-1982`／`shuu-shuu-1981` 的生年仍是暫定值，🚧 無法解除。
- **麗麗入天王寺年**：wiki 記 1993、ISB 記 `OSAKA 12 Dec 1991`。此差異該頁備注 2026-08-15 已載明並
  裁定「暫未改、待園方一手佐證」，本次沿用不動。

## [2026-08-31] update | 麗麗 `lili-1986-07-05` 入天王寺日依 ISB 由「1993」改為 1991-12-12；ISB `8628` 逐欄對帳

維護者裁定：改用 ISB 資料（覆蓋該頁 2026-08-15「暫未改、待園方一手佐證」的舊決定）。

**原值與改動理由**：原記「1993」（僅到年份）出自 code4fukui レッサーパンダ開放資料，**非官方**；
ISB `8628` 記 `OSAKA 12 Dec 1991 Transfer`，官方一手且有確日，依〈官方來源可直接採用〉更正為 **1991-12-12**。

**旁證（本次一併發現全站原本自相矛盾）**：`hai-hai-1982-06-29` 與 `shan-shan-1985-06-25` 兩頁的
「園內同期」段**早已寫 1991-12-12**，只有麗麗自己的頁停在 1993。時序亦無衝突——末子 `kusu-1991-06-24`
1991-06-24 生於西山，早於移園日。

**`8628` 逐欄對帳（全對）**：♀・`5 Jul 1986` 生於 `SABAE`（`JAZGA 041C`）・sire `8528`（慶慶）／dam `8427`（秀秀）・
`styani`・歿 `24 Oct 1995`。子女 `dam 8628` 掃全表得 2 筆（`8916` スイスイ／`9177` 楠），sire 皆 `8752`（西山友友），
與頁上子女表一致。

**更新條目**：

- `lili-1986-07-05.md` — `zoos:` 兩站訖／起日由 `1993` 改 `1991-12-12`（居住史表格隨 `gen_residence` 重生）；
  補 `isb_checked: 2026-08-31`；`sources` 補 ISB 血統登録書（Wayback→dev-only）；引言 ℹ️ 的「轉園年份（暫記 1993）待考」
  改為已依 ISB 更正；備注新增逐欄對帳項，並改寫原「移動」項中「暫未改」的措辭

**未動**：`kusu-1991-06-24` 引言的「1993 年移居廣島市安佐動物公園」講的是**楠自己**的搬園、與其母無關，不受本次影響。

## [2026-08-31] update | 美美 `mii-mii-1992-08-07` 補日文讀音 メイメイ（原記 ミーミー），全站同名注意改寫

維護者提供：本隻（ISB `9280`／RPF #371，池田生・徳山終老）的日文名為 **美美 メイメイ**，非 wiki 原記的 ミーミー。

**原值與改動理由**：`japanese:` 原僅有漢字「美美」、無假名，但內文與 index 多處寫作「美美 ミーミー」。
該讀音無官方佐證，研判係由 slug／RPF 羅馬拼音 `Mii-Mii` 逆推而來（ISB 名字欄僅記 `MIMI`，同樣是拼音縮寫、不足以定讀音）。
依〈名稱以作者提供為準、RPF 羅馬拼音僅作後備〉，改記 **メイメイ**。

**⚠️ 連帶影響（本次改動的重點）**：原本全站是用「讀音 ミーミー／メイメイ」當作本隻與繼母
`mei-mei-1991-06-16`（美美 メイメイ・ISB `9170`）唯一的區分點。兩隻現在**漢字與讀音完全相同**，
且同樣生於池田動物園、又在 1993 年 11 月相隔一天對調（本隻 11-10 池田→徳山，那隻 11-09 徳山→池田），
故所有同名注意一律改為以**生日／ISB 番號／輩分（女兒 vs 配偶）**區分，不得再靠讀音。

**更新條目**：

- `mii-mii-1992-08-07.md` — `japanese:` 由 `美美` 改為 `美美, メイメイ`；`sources` 補「維護者提供（2026-08-31，讀音 メイメイ）」；
  標題改 `# Mii-Mii（美美 メイメイ）🪽`；同名注意整段改寫（改以生日／ISB／輩分區分，並補記 `mii-mii-1994-06-26` 才是 ミーミー）
- `mei-mei-1991-06-16.md` — 同名注意由「兩隻僅以讀音與生日區分」改為「無法以名字或讀音區分，只能靠生日／ISB／輩分」
- `san-san-1984.md` — 女兒的讀音 `ミーミー` 改 `メイメイ`，並改述為「漢字與讀音皆相同」
- `index.md` — 三處：本隻條目行 `美美 ミーミー` 改 `美美 メイメイ`；`mei-mei-1991-06-16` 的兩處 ⚠️ 交叉提示同步改寫

**未動**：

- `mii-mii-1994-06-26`（RPF #359，♂）的 ミーミー **是它自己的名字**，與本次無關；`shenmi-2021-07-16` 的
  ミーミー 為 RPF 機械轉寫、亦不受影響。`mi-mi-1985-06-12`／`mii-mii-1985-06-28` 的同名清單只寫漢字，無須改。
- **slug 與 `name:` 維持 `mii-mii-1992-08-07`／`Mii-Mii`**：slug 為穩定識別碼，且 RPF／ISB 對外皆用此拼寫；
  `english_variants` 本就已收 `Mei-Mei`／`Meimei`。若維護者要一併把 `name` 正名為 Mei-Mei，
  須走 `tools/rename.py`（會撞上既有 `mei-mei-1991-06-16` 以外的同名檢查），另案處理。

## [2026-08-31] add | 池田 第三世代 京京 `jin-jin-1995-07-11`・洋洋 `yan-yan-2003-08-03` 建檔（ISB `95115`／`0376`）

維護者指定建檔。兩隻都是 `chun-chun-1992-06-22` 春春 × `yuu-yuu-1991-06-20` 友友 8 仔中**留有名字、卻一直未建條目**的
那兩隻（另兩隻有名者花花・伶伶早已建檔）。本輪先各自回 `sources/isb-red-panda/ISB-2008.txt` 逐欄核對，再建檔。

**來源**：

- sources/isb-red-panda/ISB-2008.txt（L6818 `95115`＋`95116`、L10334 `0376`＋`0377`）
- https://redpandafinder.com/#profile/734 （京京；番號取自 `fan-fan-1999-07-09` 的 RPF 手足清單，本輪未直接開啟覆核）

**ISB 逐欄（全對）**：

- `95115`＝京京：`M`／`11 Jul 1995`／sire `9258`／dam `9174`／`OKAYAMA 11 Jul 1995 Birth`／名字欄 **`JIN-JIN`**／
  `JAZGA 299C`／`styani`／`19 Sep 1999 Death`（`Unknown means`）；**無 Transfer**＝終生在池田。得年 4 歲 2 個月。
- `0376`＝洋洋：`M`／`3 Aug 2003`／sire `9258`／dam `9174`／`OKAYAMA 3 Aug 2003 Birth`／名字欄 `______`（空白）／
  `JAZGA 532C`／`styani`／`13 Oct 2004 Death`（`Other/Unknown｜Respiratory｜Unknown after necropsy`）；**無 Transfer**。得年 14 個月。
- 兩隻的同胎（`95116` 生後 33 日歿、`0377` 生歿同日，死因 `Injury from exhibit mate`）亦逐欄相符，
  均終生未命名、依〈幼逝寶寶收錄原則〉不建條目。

**新增條目**：

- `jin-jin-1995-07-11.md` — Jin-Jin 京京 ジンジン（ISB `95115`／RPF #734），♂，1995-07-11 生於池田動物園、
  1999-09-19 歿於同園（終生未離園），無子女。友友 × 春春 之長子
- `yan-yan-2003-08-03.md` — Yan-Yan 洋洋（ISB `0376`；**RPF 番號待確認**），♂，2003-08-03 生於池田動物園、
  2004-10-13 歿於同園（終生未離園），無子女。友友 × 春春 之末子；歿後兩個月母親友友亦歿，該對配偶的池田繁殖至此結束

**更新條目**：

- `chun-chun-1992-06-22.md`／`yuu-yuu-1991-06-20.md` — 子女表兩列由純文字改 wikilink、移除「未建條目」；
  表下說明由「僅 `95115` 留有名字」改為「留有名字的另兩隻已於 2026-08-31 建檔」
- `fan-fan-1999-07-09.md` — 兄弟姊妹表 RPF #734 改 wikilink 並補 ISB 與生卒日；
  RPF #735「(no name)」補 🚧 研判為洋洋（未核 #735 生卒日）
- `index.md` — 〈池田動物園 中國來源始祖一家（岡山）〉補「第三世代」說明段與表末兩列；條目總數 1149 → **1151**

**裁定與待辦**：

1. ⭐ **洋洋的羅馬拼寫定為 `Yan-Yan`（維護者裁定 2026-08-31）**：漢字「洋洋」出自同好整理資料，
   ISB 名字欄空白、RPF 無名，**讀音無任何佐證**，故 `japanese:` 只填漢字、不填假名。
   `Yan-Yan` 係比照站內既有的洋洋（京都 ISB `8524`，維護者提供讀音 ヤンヤン）與本家族的官話式讀音慣例
   （京京＝ジンジン、花花＝ファンファン）而定。日後若查到官方讀音（如ヨウヨウ）須走 `tools/rename.py`
2. ⭐ **Wayback 一輪依維護者裁定略過（2026-08-31）**：現行官網 `ikedazoo.jp`（含〈池田動物園の歴史〉年表）
   與舊官網「飼育日記」`urban.ne.jp/home/ikedazoo`（最早僅到 2009 年）皆查無 1995／2003 年代的個體記載；
   兩隻的生日均已由 ISB 釘死、非回報者或現居園提供之值，硬事實全部引 ISB
3. 🚧 **洋洋的 RPF 番號待確認**：`fan-fan-1999-07-09` 的 RPF 手足清單有 `#735`「(no name)」、2003 年生已歿，
   研判即洋洋（該清單只列一筆 2003 年手足、而 `0377` 生歿同日），但 #735 的生卒日與性別未核，`rpf_id` 暫留空
4. ℹ️ 京京的 RPF #734 亦未直接開啟 profile 逐欄覆核，僅憑手足清單的名字＋生年

**驗證**：`gen_residence`（1151 檔守門通過）→ `verify.sh`（audit `--strict` 🔴 **0**／🟡 44／⚪ 467、
index 對帳通過；`check_twins` 272 同生群、**0 錯 0 警告**）→ `isb_audit --section 1/2/4`
（覆蓋率 A 221／`isb_checked` 106；§2 兩隻皆無「與 ISB 不符」；§4 `9258`／`9174` 皆不在「子女表漏 ISB 有載」名單）。
`build_db` 走 `DB_PATH` shim ＋ `cat` 覆寫回 repo（mount 禁刪不禁覆寫）——**1151 個體／1698 親子／
318 雙胞胎／2076 居住史**，兩隻的父母邊（father `chun-chun-1992-06-22`／mother `yuu-yuu-1991-06-20`）
與居住史各 1 列均正確 → `export_json`（1151 個體／1698 親子／240 動物園，未匹配園名 0 種）→
`verify.sh` 再跑一次全綠 → `check_i18n` 5 語系 × 542 key 一致。
✅ **`redpanda.db` 與 `pipeline/data/*.json` 均已更新**，無須另跑 `rebuild.sh`。

---

## [2026-09-02] add | 愛子（ISB `8926`）逐欄對帳：子女 1→2、補建女兒ユウ、順帶修正元気的子女缺口

**來源**：

- https://web.archive.org/web/20120128200628/http://www.rotterdamzoo.nl/import/assetmanager/2/6732/Red%20Panda%20Studbook.pdf （ISB 2008 年版：`8926`／`9443`／`9392`／`93105`）
- https://redpandafinder.com/#profile/825 （Yuu／ユウ）

**對帳結果**：

- `8926` 逐欄全對：`F`／`1 Jul 1989`／sire `8713`（陽陽）／dam `8753`（愛愛）／名字欄空白／`JAZGA 109C`／`styani`，
  事件＝`NAGANO 1 Jul 1989 Birth ｜ HAMAMATSU 20 Mar 1990 Transfer ｜ 19 Jan 2001 Death`。
  `isb_audit.py` §2 無「與 ISB 不符」，**沒亮綠燈純粹是條目沒跟上 ISB**——缺口全在子女表、½ 手足行與 `sources`。
- ISB 反查 `dam == 8926` 得 2 筆（原條目只記 1 筆）：`9392`（♂，1993-06-22 生歿同日、終生未命名）
  與 `9443`（＝ユウ）。愛子 2001 年歿、元気 1995 年歿，皆早於 ISB 2008 年版截止日，兩份名單均可定案。
- RPF #751／#767 的 `children` 都只記 #825，**完全沒收 `9392`**。

**新增條目**：

- `yuu-1994-06-18.md` — Yuu ゆう／ユウ（ISB `9443`／RPF #825），♀，1994-06-18 生於浜松市動物園、
  1997-03-18 移仙台市八木山動物公園並終老、2005-01-04 歿（得年 10 歲），無子女。
  愛子 × 元気唯一長成的子女；父方是茶臼山始祖母花花的孫女、母方是花花的曾孫女

**更新條目**：

- `aiko-1989-07-01.md` — 補 `isb_checked: 2026-09-02`；`sources` 補 ISB 與「維護者提供（2026-08-02：名字「愛子」）」；
  引言「育有一女 Yuu」改為「育有一子一女」；子女表改為 ISB 格式並補 `9392`、ユウ 改 wikilink；
  ½ 手足行補 1993-07-10 生隔日夭折的 `93105`（母鈴）並把「キキ」改為 `kiki-1997-06-18` 的 wikilink、標明各自的母親；
  備注的「依 RPF #751 建檔（🚧 線索級、待官方佐證）」改為 ✅ 逐欄對帳註記
- `genki-1989-06-30.md` — `isb_checked` 由 2026-08-26 改 2026-09-02；引言「留下一女」「唯一的女兒 Yuu」
  改為一子一女；子女表補 `9392`、ユウ 改 wikilink；備注補「子女補正（ISB 反查 `sire == 8920`）」一段
- `index.md` — 茶臼山始祖母章節新增〈曾孫輩（愛子 × 元気）〉區塊與 `yuu-1994-06-18` 一列；
  愛子／元気兩列說明改寫；頁首日期 2026-09-02、條目總數 1158 → **1159**

**裁定與待辦**：

1. ⭐ **`genki` 的綠燈是漏掉 `9392` 蓋下去的**：2026-08-26 那次只逐欄核了 `8920` 自己那筆、**未做 `sire ==` 反查**。
   教訓同「最高級敘述要回 ISB 掃全批」——**標 `isb_checked` 前，本人那筆與 `sire`／`dam` 反查兩邊都要跑**
2. ⭐ **Wayback 一輪比照 2026-08-31 池田案略過**：ユウ 的生日與移動日**均出自 ISB 血統登録書（官方一手）**，
   非回報者或現居園日後撰寫之值；浜松市動物園（`hamazoo.net`）與仙台市八木山動物公園（`city.sendai.jp/zoo`）
   的現行官網、官方部落格搜過一輪，個體級記事均只回溯到 2010 年代以後。
   容器 egress 不含 `web.archive.org`、Chrome 需先選瀏覽器，故該輪未跑——**維護者若要求可補**
3. ✅ **ユウ 的漢字＝「優」（維護者提供，2026-09-02 同日補入）**：初版因 ISB 名字欄只有拉丁拼寫 `YUU`、
   RPF #825 只有假名「ゆう」／「ユウ」而暫記假名，維護者隨即確認漢字為**優**，
   `japanese` 已改 `優, ユウ`（漢字第一）、`nicknames` 併入該欄，`sources` 加「維護者提供」一行。
   讀音 ユウ 與 ISB 的 `YUU`、RPF 的假名三者一致
4. ℹ️ `93105`（1993-07-10 生、隔日夭折、母鈴）依〈幼逝寶寶收錄原則〉不建條目；父頁 `you-you-1987-07-26`
   與 `kiki-1997-06-18` 早已如此註記，本次只是讓愛子頁跟上

**驗證**：`gen_residence`（1159 檔守門通過）→ `build_db` 走 `DB_PATH` shim ＋ `cat` 覆寫回 repo
（**1159 個體／1710 親子／321 雙胞胎／2086 居住史**；`yuu-1994-06-18` 恰 2 條親子邊＝mother `aiko-1989-07-01`、
father `genki-1989-06-30`，無誤生的手足或父母邊）→ `export_json`（1159 個體／1710 親子／241 動物園，
未匹配園名 0 種）→ `verify.sh`：audit `--strict` 🔴 **0**／🟡 44／⚪ 474（與動筆前基線相同、index 對帳通過）、
`check_twins` 275 同生群 **0 錯 0 警告** → `isb_audit`：`8926`／`8920` 皆已離開 §3（可補 sources）與 §4（子女對帳），
§1 覆蓋率 A 226、`isb_checked` 111。
✅ `redpanda.db` 與 `pipeline/data/*.json` 均已更新，無須另跑 `rebuild.sh`。

---

## [2026-09-02] update | ライライ `rai-rai` 飼育期間 1973-05〜1974-03（野毛山官方 IG）：歿月補實、ISB 結構性查無由推論升格為確認

**來源**：

- https://www.instagram.com/nogeyama.zoo401/p/Dcw8-RsjXl8/ （2026-09-01；野毛山動物園官方 IG「#日めくりレッサーパンダ」系列）

貼文相關兩行逐字：`愛称（性別）　ライライ（雄）` ／ `飼育期間　1973年5月～1974年3月`。附圖為黑白舊照，圖上無額外文字。

**改動**：

- `rai-rai.md` — `died: "?"` → **`died: 1974-03`**；`zoos:` 野毛山段 `(1973 – )` → **`(1973 – 1974)`**；
  引言「歿日：不詳（確為已歿）」→「歿：1974 年 3 月」；內文補「飼育期間 1973 年 5 月～1974 年 3 月、在園約 11 個月」；
  `sources` 與 `instagram` 各補該貼文（`instagram:` 依慣例存含帳號形式＋貼文日期 2026-09-01）；
  備注新增飼育期間一段，並改寫 ISB 段落
- `index.md` — 該列年份欄 `1973–?` → `1973–1974`
- `tools/build_db.py` — `OFFICIAL_IG_ACCOUNTS` 新增 `nogeyama.zoo401`（官網
  `hama-midorinokyokai.or.jp/zoo/nogeyama/` 的 Instagram 連結指向此帳號，與 `yokohama.zoo`／`kanazawa.zoo.official`
  三園並列；未入白名單則該來源不被判為官方、個體頁來源區塊不顯示。已實測 `official_sources()` 認得）

**裁定與待辦**：

1. ⭐ **來源寫的是「飼育期間」不是歿日** → `died: 1974-03` 是一步研判：官方園史〈①昭和編〉稱兩隻「短命」、
   ISB 查無、亦無任何轉園紀錄，故末月即歿於野毛山。**確切日期仍不詳**，`待查證` tag 保留。
2. ℹ️ **月粒度進不了 `zoos:`**：`gen_residence.dates_from()` 只認 `YYYY-MM-DD` 與 `YYYY`
   （`1973-05` 會安靜地退成 `1973`、月份不顯示），故 `zoos:` 維持年粒度、月份寫在條目備注。
   日後若要讓居住史表吃月粒度，得改 `dates_from`／`fm_years`／`daterange_str` 三處——**本次未動**。
3. ⭐ **ISB 那段從「推論」升格為「確認」**：原文寫「園史稱本隻『短命』，幾乎必然在 1977 年前歿」；
   1974-03 明確早於報表起算日 `01/01/1977`，結構性查無不再是推測。**ISB 端無可補之值**
   （簿上 `RAI-RAI`／`0867` 是 2008 年生於鯖江的同名後輩，與本隻無關）。
4. ℹ️ **ノンノン 尚無對應貼文**：該系列由本隻於 2026-09-01 開篇（前一則 08-31 是「9月のマンスリー動物」預告），
   帳號時間軸上目前僅此一隻歷代個體。`non-non.md` 本次未動，歿日仍為 `"?"`，待後續貼文。

**驗證**：`gen_residence`（1159 檔守門通過、churn 僅本次 3 檔）→ `build_db` 走 `DB_PATH` shim ＋ `cat` 覆寫回 repo
（1159 個體／1710 親子／321 雙胞胎／2086 居住史）→ `export_json`（1159 個體／1710 親子／241 動物園，未匹配園名 0 種）
