...
> 🚧 待查證：出生年、入園時間與出身（園內繁殖或外園轉入）、自身家系（父母不詳，園方未公布）、官方來源（園方公告等）。性別由讀者回報之「父親」身分推定。本條目由讀者現場回報、經維護者確認後建檔，暫無官方公告佐證；查得生日後依命名規則將 slug 由 `xin-xin-dujiangyan` 更名為 `xin-xin-生日` 並同步修正 wikilink。
...
> 🚧 三筆親子關係均依讀者現場回報（@red.panda.ct，2026-08-01），園方未公布家系。黑帥性別待確認。
